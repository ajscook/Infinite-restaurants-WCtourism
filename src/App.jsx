          ...
          {tab==="three" && (
            <div style={{ display:"flex", flexDirection:"column", gap:20 }}>
              <p style={{ fontSize:15, color:C.muted, lineHeight:1.75, margin:0 }}>
                ...
                {isShort && " Your operation context from Step 1 rides in automatically as a short input block."}
              </p>
              ...
              <div style={{ border:`1px solid ${C.border}`, borderLeft:`3px solid ${C.blue}`, borderRadius:"0 10px 10px 0", padding:"18px 20px" }}>
                ...
                <div style={{ fontSize:16, fontWeight:700, color:C.text, marginBottom:8 }}>
                  {model.id==="claude" ? "Map Your Restaurant Against the Research" : model.id==="chatgpt" ? "Map Your Restaurant - Deep Research in Custom GPT" : "Map Your Restaurant - Run in Standard Gemini Deep Research"}
                </div>
                <p style={{ fontSize:14, color:C.muted, lineHeight:1.7, marginBottom:12 }}>
                  {model.id==="claude"
                    ...
                    : model.id==="chatgpt"
                    ? "Paste your input block into the Custom GPT. Deep research runs inside the tool. Output is a profile document you hold."
                ...
                {activePrompt===1 && <PromptBox value={prompts[1]} minH={isShort?100:200}/>}
              </div>
              ...
              <div style={{ border:`1px solid ${C.border}`, borderLeft:`3px solid ${C.blue}`, borderRadius:"0 10px 10px 0", padding:"18px 20px" }}>
                ...
                <p style={{ fontSize:14, color:C.muted, lineHeight:1.7, marginBottom:12 }}>
                  {model.id==="gemini" ? "In the Gem. " : ""}Your AI opens already loaded with both research outputs. You direct toward the decision that matters most right now.
                </p>
          ...
          {tab==="one" && (
            <div style={{ display:"flex", flexDirection:"column", gap:0 }}>
              ...
              <div style={{ borderTop:`1px solid ${C.border}`, paddingTop:20, paddingBottom:8, marginTop:8 }}>
                <div style={{ fontSize:12, fontWeight:700, letterSpacing:".12em", textTransform:"uppercase", color:C.blue, marginBottom:6 }}>Don't see your situation?</div>
                <p style={{ fontSize:14, color:C.muted, lineHeight:1.7, marginBottom:12 }}>Describe what you need to think through. Generates a prompt with the same research discipline and HI-AI-HI framing.</p>
