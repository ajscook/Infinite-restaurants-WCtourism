    ...
    <Sec id="ai" num="05" label="HI-AI-HI Prompts" accent={C.blue}>
      ...
      <button onClick={() => setBriefOpen(o => !o)} style={{ width:"100%", background:"none", border:"none", cursor:"pointer", padding:0, display:"block", textAlign:"left" }}>
        <div className="card-blue" style={{ background:C.surface, borderRadius:12, padding:"20px 22px", display:"flex", flexDirection:"column" }}>
          ...
          <p style={{ fontSize:18, color:C.muted, lineHeight:1.75, marginBottom:16 }}>Seven questions. Your AI comes back knowing your restaurant and what the World Cup means for it specifically - then opens a planning conversation already loaded with what it found.</p>
          <div style={{ marginTop:"auto", display:"flex", justifyContent:"flex-end" }}>
      ...
      <div className={`xbody ${briefOpen?"open":""}`}>
        <div style={{ padding:"24px 4px 8px", display:"flex", flexDirection:"column", gap:14 }}>
          <p style={{ fontSize:18, color:C.muted, lineHeight:1.78 }}>Answer seven questions about your restaurant - address, setup, hours flexibility, inventory position. The generator builds two prompts from what you tell it.</p>
          ...
          <p style={{ fontSize:18, color:C.muted, lineHeight:1.78 }}>The second prompt opens the planning conversation already loaded with that context. Your AI isn't starting cold. You're not explaining your situation from scratch. You pick up where the research left off.</p>
        ...
        <button onClick={() => setHiOpen(o => !o)} style={{ width:"100%", background:"none", border:"none", cursor:"pointer", padding:0, display:"block", textAlign:"left" }}>
          <div className="callout-left-orange" style={{ background:C.surface, borderRadius:12, padding:"20px 22px", display:"flex", flexDirection:"column" }}>
            <div>
              ...
              <p style={{ fontSize:18, color:C.muted, lineHeight:1.75, marginBottom:16 }}>How this platform thinks about AI, platform insights, and some red &amp; green flags.</p>
            </div>
            <div style={{ marginTop:"auto", display:"flex", justifyContent:"flex-end" }}>
