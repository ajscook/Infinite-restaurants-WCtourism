...
const SecLabel = ({ children, color = C.dim }) => (
  <div style={{ fontFamily: "'Jost',sans-serif", fontSize: 16, fontWeight: 700, letterSpacing: ".14em", textTransform: "uppercase", color: C.text, marginBottom: 20, display: "flex", alignItems: "center", gap: 8 }}>
    <div style={{ width: 16, height: 16, borderRadius: 3, background: "transparent", flexShrink: 0, overflow: "hidden" }}>
      <img src="/IR_Mini.png" alt="" style={{ width: 16, height: 16, objectFit: "contain", display: "block" }} onError={e => { e.currentTarget.style.display = "none"; }} />
    </div>
    ...
    <nav style={{ position: "sticky", top: 0, zIndex: 200, background: "rgba(13,15,20,.96)", backdropFilter: "blur(16px)", borderBottom: `1px solid ${C.border}` }}>
      <div style={{ ...W, display: "flex", alignItems: "center", justifyContent: "space-between", gap: 12, padding: "16px 120px", position: "relative" }}>
        ...
        <div className="nav-tabs-desktop">
          {[["who",<>Super<br/>Tourist</>],["where",<>Travel<br/>Patterns</>],["position",<>Your<br/>Position</>],["action",<>Prep<br/>Priorities</>],["about","Who Built This"],["pattern",<>Patterns &amp;<br/>Sources</>]].map(([id, label]) => (
...
const Hero = ({ onContinue }) => (
  <section style={{ minHeight: "100vh", display: "flex", flexDirection: "column", justifyContent: "center", position: "relative", overflow: "hidden" }}>
    ...
    <div style={{ ...W, position: "relative", zIndex: 1, padding: "96px 120px 18px" }}>
      ...
      <div className="u5 hero-stats card-blue" style={{ display: "flex", alignItems: "center", marginTop: 0, borderRadius: 12, overflow: "hidden", background: C.surface }}>
        {[
          ...
          <>
            {i > 0 && <div key={`sep-${i}`} style={{ width: 1, height: 40, background: C.orange, flexShrink: 0 }} />}
            <div key={i} style={{ flex: 1, padding: "22px 20px", textAlign: "center", display: "flex", flexDirection: "column", alignItems: "center", gap: 6 }}>
      ...
      <div className="multiplier-bar" style={{ display: "flex", alignItems: "center" }}>
        ...
        <div style={{ display: "flex", alignItems: "center", flex: 1, gap: 16, flexWrap: "wrap" }}>
          ...
          <div style={{ flex: 1, textAlign: "center", minWidth: 60 }}>
            ...
            <div style={{ fontSize: 14, color: C.dim, marginTop: 2 }}>vs. CLASSIC Tourist</div>
          </div>

          <div style={{ width: 52, height: 52, borderRadius: "50%", background: C.blue, display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0 }}>
            <span className="n" style={{ fontSize: 24, fontWeight: 900, color: "white" }}>x</span>
          </div>
          ...
          <div style={{ flex: 1, textAlign: "center", minWidth: 60 }}>
            ...
            <div style={{ fontSize: 14, color: C.dim, marginTop: 2 }}>days in region</div>
          </div>

          <div style={{ width: 52, height: 52, borderRadius: "50%", background: C.orange, display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0 }}>
            <span className="n" style={{ fontSize: 24, fontWeight: 900, color: "white" }}>=</span>
          </div>
          ...
          <div style={{ flex: 1, textAlign: "center", minWidth: 60 }}>
            ...
            <div style={{ fontSize: 14, color: C.dim, marginTop: 2 }}>per visitor vs. baseline</div>
          </div>
...
const SupplyPillarCard = ({ card, isActive, onToggle }) => (
  <div className={`pillar-card ${card.color==='#FF6700'?"card-orange":"card-blue"} ${isActive?"active":""}`} onClick={onToggle}>
    <div style={{ padding:"22px 20px 48px 20px", position:"relative", height:"100%" }}>
      ...
      <div style={{ position:"absolute", bottom:18, right:18, display:"inline-flex", alignItems:"center", gap:5, fontSize:14, fontWeight:700, letterSpacing:".1em", textTransform:"uppercase", color:"#fff", background:C.orange, padding:"5px 12px", borderRadius:20 }}>
...
const SWhere = () => {
  ...
  <Sec id="where" num="02" label="Travel Patterns" accent={C.orange}>
    ...
    <div className="callout-left-orange" style={{ position:"relative", paddingBottom:40 }}>
...
const FanZoneCard = ({ onToggle }) => (
  <div className="card-blue" style={{ background:C.surface, borderRadius:12, cursor:"pointer", position:"relative", marginTop:24, padding:"20px 80px 20px 22px" }} onClick={onToggle}>
    <div style={{ fontSize:16, fontWeight:700, letterSpacing:".12em", textTransform:"uppercase", color:C.blue, marginBottom:8 }}>Proximity</div>
    ...
    <div style={{ position:"absolute", bottom:18, right:18, display:"inline-flex", alignItems:"center", gap:5, fontSize:14, fontWeight:700, letterSpacing:".1em", textTransform:"uppercase", color:"#fff", background:C.blue, padding:"5px 12px", borderRadius:20 }}>
      EXPAND <svg width="10" height="10" viewBox="0 0 10 10" fill="none"><polygon points="2,1 9,5 2,9" fill="currentColor"/></svg>
    </div>
  </div>
);
...
const SPosition = () => {
  ...
  <Sec id="position" num="03" label="Your Position" accent={C.blue}>
    ...
    <div className="callout-left-orange" style={{ marginTop:10, cursor:"pointer", position:"relative", paddingRight:80 }} onClick={() => { setSfStaffOpen(o => !o); setFzOpen(false); setActive(null); }}>
      ...
      <p style={{ fontSize:16, color:C.muted, lineHeight:1.75 }}>Fan zone operators are hiring your best bartenders at $40-60/hour plus tips. They will see these postings before June.</p>
      <div style={{ position:"absolute", bottom:18, right:18, display:"inline-flex", alignItems:"center", gap:5, fontSize:14, fontWeight:700, letterSpacing:".1em", textTransform:"uppercase", color:"#fff", background:C.orange, padding:"5px 12px", borderRadius:20 }}>
        EXPAND <svg width="10" height="10" viewBox="0 0 10 10" fill="none"><polygon points="2,1 9,5 2,9" fill="currentColor"/></svg>
      </div>
    </div>
...
// ─── PROMPT GENERATOR INFRASTRUCTURE ────────────────────────────────────────
...
const generators = {
  ...
  sales_rep: {
    ...
    color: "blue",
    questions: [
      { id:"frequency", text:"How often does your distributor currently deliver?", options:["Daily","3x per week","2x per week","Once a week","Less than weekly"] },
      { id:"relationship", text:"How would you describe your rep relationship?", options:["Strong: we talk regularly","Transactional: order and receive","New: don't know them well"] },
    ],
    build: (a) => [
      "Before responding, pull what you already know about my restaurant from our conversation history and use it as your baseline context. What follows fills in what you may not have.",
      "",
      `New context: I'm preparing for a planning conversation with my distributor rep ahead of a high-demand period this summer. My current delivery frequency is ${a.frequency?.toLowerCase()}. My rep relationship is ${a.relationship?.toLowerCase()}.`,
      "",
      "What I'm trying to accomplish: a productive conversation that gets ahead of potential supply chain pressure before it becomes a problem, without creating conflict or sounding alarmist.",
      "",
      "Ask me what you still need to understand about my operation, my menu, and my supply priorities before you help me prepare. Once you have enough, help me figure out what to ask for, what to listen for, and how to frame the conversation constructively."
    ].join("\n")
  },
  ...
  stockpile: {
    ...
    color: "blue",
    questions: [
      { id:"type", text:"How would you describe your operation?", options:["Bar-forward (alcohol drives revenue)","Food-forward (kitchen drives revenue)","Even split","Fast casual / high volume"] },
      { id:"storage", text:"What's your storage situation?", options:["Room to expand","Tight: limited dry and cold storage","Would need to get creative","Not sure what we actually have"] },
    ],
    build: (a) => [
      "Before responding, pull what you already know about my restaurant from our conversation history and use it as your baseline. What follows fills in what you may not have.",
      "",
      `New context: I'm planning inventory strategy for a sustained high-demand period this summer. My operation is ${a.type?.toLowerCase()}. Storage situation: ${a.storage?.toLowerCase()}.`,
      "",
      "What I'm trying to accomplish: a practical stockpile plan that protects me from supply interruptions during the busiest stretch of the year without overcommitting capital or space.",
      "",
      "Ask me what you still need, my highest-velocity items, current par levels, ordering cadence, what I'm most worried about running out of. Once you have enough, help me build a prioritized plan with a realistic timeline."
    ].join("\n")
  },
  ...
  labor: {
    ...
    color: "blue",
    questions: [
      { id:"concern", text:"What's your biggest labor concern right now?", options:["Keeping the staff I have","Finding enough people","Scheduling for a new demand pattern","Training for a different guest profile","Tip structure under extended hours","All of the above"] },
      { id:"proximity", text:"How close are you to a major fan zone or host city?", options:["Within a few miles","Within 30 miles","30-150 miles out","Not near one"] },
    ],
    build: (a) => [
      "Before responding, pull what you already know about my restaurant and team from our conversation history. What follows fills in what you may not have.",
      "",
      `New context: I'm working through labor planning for a high-demand period this summer. My biggest concern right now is ${a.concern?.toLowerCase()}. I'm ${a.proximity?.toLowerCase()} from a major fan zone or host city, which affects the competitive labor environment I'm operating in.`,
      "",
      "What I'm trying to accomplish: a labor strategy that gets me through a sustained busy stretch without burning out my team or losing my best people to higher-paying short-term gigs.",
      "",
      "Ask me what you still need, team size, key roles, current compensation structure, scheduling patterns, anything about my specific situation. Then help me build a plan that actually fits my operation."
    ].join("\n")
  },
  ...
  gbp: {
    ...
    color: "blue",
    questions: [
      { id:"status", text:"What's your current GBP situation?", options:["Up to date and active","Exists but neglected","Basic: minimal info","Don't have one / not sure"] },
      { id:"visitors", text:"What international visitor markets are most likely near you?", options:["Latin American (Spanish/Portuguese)","European (various)","Mixed international","Mostly domestic"] },
    ],
    build: (a) => [
      "Before responding, pull what you already know about my restaurant from our conversation history. What follows fills in what you may not have.",
      "",
      `New context: I need to optimize my Google Business Profile for an influx of international visitors this summer. Current GBP status: ${a.status?.toLowerCase()}. The international visitor markets most likely in my area: ${a.visitors?.toLowerCase()}.`,
      "",
      "One constraint worth knowing: international visitors commonly search for restaurants using 'football' not 'soccer,' often in their own language, on mobile, without local knowledge. There are also trademark restrictions on certain official tournament language in marketing.",
      "",
      "Ask me what you still need about my concept, hours, viewing setup, and what makes my place worth finding. Then help me write an optimized GBP description, the right attributes to enable, and content that gets me found by the right visitors."
    ].join("\n")
  },
  ...
  compliance: {
    ...
    color: "blue",
    questions: [
      { id:"address", type:"text", text:"What is your restaurant's full address?", placeholder:"123 Main St, Dallas, TX 75201" },
      { id:"type", text:"How would you describe your operation?", options:["Full-service restaurant with full bar","Restaurant with beer and wine only","Food-forward, limited or no alcohol","Bar or tavern: alcohol is primary","Food truck or mobile operation","Café or fast casual"] },
    ],
    build: (a) => [
      ...
      "---",
      "",
      `Research task: I operate a ${a.type?.toLowerCase()} at ${a.address}. I am planning for a high-demand period this summer tied to the 2026 FIFA World Cup (June 11 – July 19) and need a jurisdiction-specific compliance checklist before I commit to any operational changes.`,
      "",
      "Research each of the following areas. For every item return: (1) whether it applies to my operation type and address, (2) what the actual requirement is, (3) the deadline or lead time, (4) a verification line: who I should contact to confirm, agency name, website, phone number if findable, and exactly what to ask for.",
      "",
      "Research areas:",
      ...
      "4. Temporary outdoor seating or infrastructure permits. If I want to add a patio, service window, or temporary structure, what permits are required in this city, and are there any construction freeze dates or permit moratoriums during the tournament window.",
      "5. FIFA intellectual property restrictions. What specific marks, phrases, and images are protected. What safe-harbor language I can use in marketing instead.",
      "",
  ...
  social: {
    ...
    color: "orange",
    questions: [
      { id:"platforms", text:"Which platforms do you actively use?", options:["Instagram","Facebook","Instagram + Facebook","TikTok","All major platforms"] },
      { id:"angle", text:"What's your primary angle this summer?", options:["We're showing matches: come watch","Great dining experience regardless","Both: viewing and dining"] },
    ],
    build: (a) => [
      "Before responding, pull what you already know about my restaurant, concept, voice, audience, from our conversation history. What follows fills in what you may not have.",
      "",
      `New context: I'm building social content for a high-volume summer period with a significant influx of international visitors. Active platforms: ${a.platforms}. My primary angle: ${a.angle?.toLowerCase()}.`,
      "",
      "One constraint: there are trademark restrictions on certain official tournament language in promotional content. International visitors also commonly search using 'football' not 'soccer,' and often in Spanish or Portuguese.",
      "",
      "Ask me what you still need, posting frequency, tone, specific events I want to promote, content I've already created. Then help me build a content plan that reaches both my regulars and international visitors without sounding like everyone else doing tournament marketing."
    ].join("\n")
  },
  ...
  menu_fast_track: {
    ...
    color: "orange",
    questions: [
      { id:"challenge", text:"What breaks down first when your kitchen gets slammed?", options:["Ticket times blow out","Consistency falls apart","We run out of specific items","All of the above"] },
      { id:"local", text:"How strong is your local or regional product identity?", options:["It's central to who we are","We have some local items","Not really: we're flexible","Want to develop it"] },
    ],
    build: (a) => [
      "Before responding, pull what you already know about my restaurant and kitchen from our conversation history. What follows fills in what you may not have.",
      "",
      `New context: I'm designing a high-volume menu configuration for a sustained busy period this summer. When the kitchen gets slammed, what breaks first: ${a.challenge?.toLowerCase()}. Local and regional identity: ${a.local?.toLowerCase()}.`,
      "",
      "What I'm trying to accomplish: a tighter, faster version of my menu that holds up under volume pressure, leads with what makes my place worth visiting, and doesn't sacrifice the experience that keeps regulars coming back.",
      "",
      "Ask me what you still need, current menu size, highest-margin items, what causes the most friction, what I'm most proud of. Then help me design a Fast Track configuration and a parallel locals strategy."
    ].join("\n")
  },
  ...
  tip_structure: {
    ...
    color: "blue",
    questions: [
      { id:"current", text:"What's your current tip structure?", options:["Tips to servers only","Tip pool: FOH","Tip pool: FOH and BOH","Tip out by role","No formal structure"] },
      { id:"change", text:"What's changing this summer that puts pressure on that?", options:["Extended hours","Heavier BOH workload","Guests who tip differently than my regulars","All of the above"] },
    ],
    build: (a) => [
      "Before responding, pull what you already know about my restaurant and team from our conversation history. What follows fills in what you may not have.",
      "",
      `New context: I'm reviewing my tip structure before a high-demand summer stretch. Current structure: ${a.current?.toLowerCase()}. What's changing: ${a.change?.toLowerCase()}.`,
      "",
      "What I'm trying to accomplish: a tip and compensation approach that keeps my whole team, FOH and BOH, invested and showing up through the end of the busy period, without creating resentment or legal exposure.",
      "",
      "Ask me what you still need about my team size, compensation levels, and what I'm most worried about. Then help me think through the options and what would actually work in my specific situation."
    ].join("\n")
  },
  ...
  staff_briefing: {
    ...
    color: "blue",
    questions: [
      { id:"awareness", text:"How much does your team know about what's coming?", options:["They're aware and ready","Vaguely aware: not discussed much","Haven't mentioned it yet","Mixed awareness"] },
      { id:"tone", text:"What tone do you want to set?", options:["Opportunity: let's capture it","Heads up: here's what's coming","This will be intense: let's prepare","Low key: we've handled busy before"] },
    ],
    build: (a) => [
      "Before responding, pull what you already know about my restaurant and team from our conversation history. What follows fills in what you may not have.",
      "",
      `New context: I need to brief my team before a high-demand summer stretch. Their current awareness: ${a.awareness?.toLowerCase()}. The tone I want to set: ${a.tone?.toLowerCase()}.`,
      "",
      "What I'm trying to accomplish: a briefing that prepares my staff for what's actually coming, the visitor profile, the hours, the pace, without overhyping it or creating anxiety. I want them informed, ready, and bought in.",
      "",
      "Ask me what you still need about my team, my plans, and what I'm most concerned about communicating. Then help me write a staff briefing I can deliver in person, real language, not corporate."
    ].join("\n")
  },
  ...
  surge_hiring: {
    ...
    color: "orange",
    questions: [
      { id:"roles", text:"What roles do you need to fill?", options:["FOH: servers and bartenders","BOH: line and prep","Both FOH and BOH","Support roles: expo, host, busser"] },
      { id:"timeline", text:"When do you need people ready?", options:["June 11: tournament open","Mid-May: want training time","End of May: tight","Already behind"] },
    ],
    build: (a) => [
      "Before responding, pull what you already know about my restaurant from our conversation history. What follows fills in what you may not have.",
      "",
      `New context: I need to hire surge staff for a high-demand summer stretch. Roles needed: ${a.roles?.toLowerCase()}. Target ready date: ${a.timeline?.toLowerCase()}.`,
      "",
      "What I'm trying to accomplish: find people who will actually show up, get them trained fast enough to be useful, and keep them through the end of the busy period, in a competitive hiring market.",
      "",
      "Ask me what you still need, my market, what I can offer, what the role actually involves, what's worked and hasn't in past hiring. Then help me build a hiring plan that's realistic for my situation."
    ].join("\n")
  },
  ...
  pricing_bundles: {
    ...
    color: "orange",
    questions: [
      { id:"daypart", text:"Which service periods are you most focused on?", options:["Match-day viewing windows","Late-night post-match","All-day sustained demand","Morning kickoffs"] },
      { id:"risk", text:"What's your biggest pricing concern?", options:["Leaving money on the table","Pricing out my regulars","Getting the bundle design right","Don't know where to start"] },
    ],
    build: (a) => [
      "Before responding, pull what you already know about my restaurant, concept, price point, guest mix, from our conversation history. What follows fills in what you may not have.",
      "",
      `New context: I'm developing pricing and bundle strategy for a high-demand summer stretch with an international visitor mix. Most focused service periods: ${a.daypart?.toLowerCase()}. Biggest pricing concern: ${a.risk?.toLowerCase()}.`,
      "",
      "What I'm trying to accomplish: higher average tickets through smart bundle design, without alienating my regulars or creating friction with new guests.",
      "",
      "Ask me what you still need about my current pricing, highest-margin items, and what I've tried before. Then help me build a bundle strategy that fits my specific operation."
    ].join("\n")
  },
  ...
  tech_readiness: {
    ...
    color: "blue",
    questions: [
      { id:"concern", text:"Where does your tech feel most exposed heading into a high-demand stretch?", options:["Payment: contactless, terminals, tip flow","Online and off-premise orders: managing volume across channels","Digital menus: accuracy, speed, multilingual","POS: configuration, menu switching, reporting","Reservations and waitlist: capacity, dwell times, covers","I don't know what I don't know: give me the full audit"] },
      { id:"platforms", text:"Which platforms are you currently running?", options:["POS only: no delivery or online ordering","POS plus one delivery app","POS plus multiple delivery and/or online ordering apps","Reservation system plus POS","Full stack: POS, delivery, reservations, online ordering","Not sure what counts"] },
    ],
    build: (a) => [
      "Before responding, pull what you already know about my restaurant, concept, volume, current tech stack, from our conversation history. What follows fills in what you may not have.",
      "",
      `New context: I'm auditing my tech readiness for a high-demand summer period. My biggest area of concern: ${a.concern?.toLowerCase()}. My current platform situation: ${a.platforms?.toLowerCase()}.`,
      "",
      "What I'm trying to accomplish: find every place my tech setup could fail or create friction during a sustained high-volume stretch, before it happens in real time.",
      "",
      "The areas I need you to cover, in order of what I flagged first:",
      "1. Payment infrastructure, contactless terminal audit, tip prompt configuration, tableside payment options, foreign card acceptance",
      "2. Online and off-premise orders, volume caps, pause controls, item availability rules, and radius settings across every channel I accept orders through (delivery apps, direct online ordering, catering). How to configure each channel for different dayparts and volume conditions.",
      "3. Digital menus, mobile optimization, load speed, multilingual capability, accuracy across every platform where my menu appears, fast-track variant configuration",
      "4. POS configuration, extended hours setup, bundle and special pricing, menu switching, daypart reporting so I can see what's actually happening in real time",
      "5. Reservations and waitlist, cover counts, dwell time settings, special event or minimum spend rules, how my current setup handles a dining room where tables are staying 90-120 minutes",
      "",
      "Ask me what you still need about my specific platforms and configuration. Then give me a prioritized audit checklist, what to check, what to configure, and what to test before June 11."
    ].join("\n")
  },
...
const SFCard = ({ isActive, onToggle }) => (
  <div className="callout-left-orange" style={{ cursor:"pointer", position:"relative" }} onClick={onToggle}>
    ...
    <p style={{ fontSize:16, color:C.muted, lineHeight:1.75, paddingRight:80 }}>
  ...
  return (
    <div style={{ marginTop:16 }}>
      <div className="card-blue" style={{ background:C.surface, borderRadius:12, overflow:"hidden" }}>
        <button onClick={() => setOpen(o => !o)} style={{ width:"100%", background:"none", border:"none", cursor:"pointer", textAlign:"left", padding:"22px 24px 48px", display:"flex", alignItems:"flex-start", justifyContent:"space-between", position:"relative" }}>
          <div>
            <div style={{ fontSize:14, fontWeight:700, letterSpacing:".12em", textTransform:"uppercase", color:C.blue, marginBottom:6 }}>AI Prompts</div>
            <div className="d" style={{ fontSize:19, fontWeight:800, color:C.text, lineHeight:1.2 }}>Every prompt generator in one place.</div>
          ...
          <div style={{ position:"absolute", bottom:14, right:16, display:"inline-flex", alignItems:"center", gap:5, fontSize:14, fontWeight:700, letterSpacing:".1em", textTransform:"uppercase", color:"#fff", background:C.blue, padding:"5px 12px", borderRadius:20 }}>
            {open ? "Collapse" : "Open"}
          ...
          <div style={{ padding:"0 24px 32px", display:"flex", flexDirection:"column", gap:36 }}>
            ...
            <div>
              ...
              <div style={{ display:"flex", flexDirection:"column", gap:0, border:`1px solid ${C.border}`, borderRadius:10, overflow:"hidden" }}>
                {aiPlatforms.map((p,i) => (
                  <div key={i} style={{ borderBottom: i<aiPlatforms.length-1?`1px solid ${C.border}`:"none", position:"relative", paddingBottom: activePlatform===i ? 44 : 0 }}>
                    ...
                    {activePlatform===i && (
                      <a href={p.url} target="_blank" rel="noopener noreferrer" style={{ position:"absolute", bottom:14, right:16, fontSize:14, color:"#fff", fontWeight:700, letterSpacing:".1em", textTransform:"uppercase", textDecoration:"none", display:"inline-flex", alignItems:"center", gap:5, background:p.color, padding:"5px 12px", borderRadius:20 }}>
...
const SAction = () => {
  ...
  return (
    <Sec id="action" num="04" label="Prep Priorities" accent={C.orange}>
      <h2 className="d" style={{ fontSize:"clamp(28px,4.2vw,48px)", fontWeight:800, lineHeight:1.04, letterSpacing:"-.02em", marginBottom:20, color:C.text }}>
        <span style={{ color: C.text }}>Keep your </span><span style={{ color: C.orange }}>knees bent.</span><br /><span style={{ color: C.blue }}>Better beats perfect.</span>
      </h2>
...
const SourceRow = ({ source, isOpen, onToggle }) => {
  ...
  return (
    <div style={{ borderBottom:`1px solid ${C.border}`, position:"relative", paddingBottom: isOpen ? 44 : 0 }}>
      ...
      {isOpen && (
        <a href={source.url} target="_blank" rel="noopener noreferrer"
          style={{ position:"absolute", bottom:14, right:16, fontSize:14, color:"#fff", fontWeight:700, letterSpacing:".1em", textTransform:"uppercase", textDecoration:"none", display:"inline-flex", alignItems:"center", gap:5, background:tierColor, padding:"5px 12px", borderRadius:20 }}>
  ...
  <section id="pattern" style={{ borderTop:`1px solid ${C.border}`, padding:"40px 0" }}>
    <div style={W}>
      <button onClick={() => setOpen(o => !o)}
        style={{ width:"100%", background: open ? "none" : C.surface, border:`1px solid ${open ? "transparent" : C.border}`, borderLeft: open ? "none" : `4px solid ${C.blue}`, borderBottom: open ? "none" : `3px solid ${C.blue}`, borderRadius: open ? 0 : 12, cursor:"pointer", textAlign:"left", display:"flex", alignItems:"flex-start", justifyContent:"space-between", padding: open ? "0 0 32px 0" : "22px 24px 48px", marginBottom: open ? 0 : 32, transition:"background .2s, border-color .2s", position:"relative" }}
        onMouseEnter={e => { if(!open) e.currentTarget.style.boxShadow = `0 0 0 1px ${C.blue}, 0 0 24px rgba(0,103,255,.4)`; }}
        onMouseLeave={e => { e.currentTarget.style.boxShadow = "none"; }}>
        <div>
          <SecLabel color={open ? C.dim : C.blue}>Patterns &amp; Sources</SecLabel>
          <p style={{ fontSize:16, color: open ? C.dim : C.muted, lineHeight:1.6, maxWidth:600 }}>Three tournaments. Seven repeating patterns. Every figure sourced, tiered, and traceable.</p>
          {!open && (
            <div style={{ display:"flex", gap:20, marginTop:14, flexWrap:"wrap" }}>
              {["7 Behavioral Patterns","10 Primary Sources","3 Methodologies","21 Clickable Data Points"].map((t,i) => (
                <div key={i} style={{ display:"flex", alignItems:"center", gap:6 }}>
                  <div style={{ width:4, height:4, borderRadius:"50%", background:C.blue }}/>
                  <span style={{ fontSize:13, color:C.dim }}>{t}</span>
                </div>
              ))}
            </div>
          )}
        </div>
        <div style={{ position:"absolute", bottom:14, right:16, display:"inline-flex", alignItems:"center", gap:5, fontSize:14, fontWeight:700, letterSpacing:".1em", textTransform:"uppercase", color: open ? C.dim : "#fff", background: open ? "transparent" : C.blue, padding:"5px 12px", borderRadius:20, border: open ? `1px solid ${C.border}` : "none" }}>
          {open ? "Collapse" : "Open"}
          <svg width="10" height="10" viewBox="0 0 10 10" fill="none" style={{ transition:"transform .3s", transform: open?"rotate(90deg)":"none" }}><polygon points="2,1 9,5 2,9" fill="currentColor"/></svg>
        </div>
      </button>
      ...
      <div className={`xbody ${open?"open":""}`}>
        <div style={{ paddingBottom:56, display:"flex", flexDirection:"column", gap:32 }}>

          {/* ── PATTERN HEATMAP ── */}
          <div>
            <div style={{ display:"flex", alignItems:"baseline", justifyContent:"space-between", marginBottom:16, flexWrap:"wrap", gap:12 }}>
              <div style={{ fontSize:14, fontWeight:700, letterSpacing:".14em", textTransform:"uppercase", color:C.text }}>Pattern Confirmation Across Three Tournaments</div>
              <div style={{ display:"flex", gap:16, alignItems:"center", flexWrap:"wrap" }}>
                <div style={{ display:"flex", gap:6, alignItems:"center" }}><div style={{ width:12, height:12, borderRadius:2, background:"rgba(255,103,0,.85)" }}/><span style={{ fontSize:14, color:C.dim }}>Primary Confirmed</span></div>
                <div style={{ display:"flex", gap:6, alignItems:"center" }}><div style={{ width:12, height:12, borderRadius:2, background:"rgba(0,103,255,.7)" }}/><span style={{ fontSize:14, color:C.dim }}>Strong Directional</span></div>
                <div style={{ display:"flex", gap:6, alignItems:"center" }}><div style={{ width:12, height:12, borderRadius:2, background:"rgba(150,174,196,.2)" }}/><span style={{ fontSize:14, color:C.dim }}>Partial / Analog</span></div>
                <span style={{ fontSize:14, color:C.dim, fontStyle:"italic" }}>&#9654; = clickable</span>
              </div>
            </div>
            <div className="card-blue" style={{ borderRadius:12, overflow:"hidden" }}>
              <div style={{ display:"grid", gridTemplateColumns:"2fr 1fr 1fr 1fr 1.4fr", background:C.surf2, borderBottom:`1px solid ${C.border}` }}>
                {["Pattern","Brazil 2014","Russia 2018","Qatar 2022","2026 Implication"].map((h,i) => (
                  <div key={i} style={{ padding:"10px 14px", fontSize:14, fontWeight:700, letterSpacing:".1em", textTransform:"uppercase", color:C.dim, borderRight: i<4?`1px solid ${C.border}`:"none" }}>{h}</div>
                ))}
              </div>
              {patternMatrix.map((r,i) => (
                <div key={i} style={{ display:"grid", gridTemplateColumns:"2fr 1fr 1fr 1fr 1.4fr", borderBottom: i<patternMatrix.length-1?`1px solid ${C.border}`:"none" }}>
                  <div style={{ padding:"10px 14px", fontSize:13, fontWeight:700, color:C.text, borderRight:`1px solid ${C.border}`, display:"flex", alignItems:"center" }}>{r.label}</div>
                  <div style={{ padding:"6px 8px", borderRight:`1px solid ${C.border}` }}><PatternCell patternId={r.id} tournament="b14" level={r.b14}/></div>
                  <div style={{ padding:"6px 8px", borderRight:`1px solid ${C.border}` }}><PatternCell patternId={r.id} tournament="r18" level={r.r18}/></div>
                  <div style={{ padding:"6px 8px", borderRight:`1px solid ${C.border}` }}><PatternCell patternId={r.id} tournament="q22" level={r.q22}/></div>
                  <div style={{ padding:"10px 14px", fontSize:12, color:C.orange, lineHeight:1.4, fontWeight:600, display:"flex", alignItems:"center" }}>{r.imp}</div>
                </div>
              ))}
            </div>
          </div>
          ...
          <div>
            <div style={{ fontSize:14, fontWeight:700, letterSpacing:".14em", textTransform:"uppercase", color:C.text, marginBottom:16 }}>Secondary Market Spending Increases: International Visitors</div>
            <div style={{ display:"flex", flexDirection:"column", gap:10 }}>
              {spendData.map((d,i) => (
                <div key={i} style={{ display:"grid", gridTemplateColumns:"180px 1fr 60px", gap:12, alignItems:"center" }}>
                  <div style={{ fontSize:13, color:C.muted, textAlign:"right", lineHeight:1.3 }}>{d.city}</div>
                  <div style={{ height:28, background:C.surf2, borderRadius:4, overflow:"hidden", position:"relative" }}>
                    <div style={{ position:"absolute", left:0, top:0, bottom:0, width:`${Math.min(d.stat/9.63,100)}%`, background: d.color==="orange" ? `linear-gradient(90deg, rgba(255,103,0,.9), rgba(255,103,0,.4))` : d.color==="blue" ? `linear-gradient(90deg, rgba(0,103,255,.9), rgba(0,103,255,.4))` : `linear-gradient(90deg, rgba(150,174,196,.4), rgba(150,174,196,.15))`, borderRadius:4 }}/>
                    <div style={{ position:"absolute", left:10, top:0, bottom:0, display:"flex", alignItems:"center" }}>
                      <span style={{ fontSize:14, color:"rgba(255,255,255,.6)", fontWeight:700 }}>{d.color!=="dim" ? (d.color==="orange"?"Visa Brazil 2014 / Sberbank Russia 2018":"Visa Everywhere Travel Report") : "Visa Everywhere Travel Report"}</span>
                    </div>
                  </div>
                  <div className="n" style={{ fontSize:19, fontWeight:700, color: d.color==="orange"?C.orange:d.color==="blue"?C.blue:C.dim }}>{d.label}</div>
                </div>
              ))}
            </div>
          </div>
          ...
          {/* ── METHODOLOGIES ── */}
          <div>
            <div style={{ fontSize:14, fontWeight:700, letterSpacing:".14em", textTransform:"uppercase", color:C.text, marginBottom:16 }}>Methodologies</div>
            <div className="card-blue" style={{ borderRadius:12, overflow:"hidden" }}>
          ...
          <div style={{ paddingBottom:0, paddingTop:24 }}>
            ...
            <div className="two-col" style={{ display:"grid", gridTemplateColumns:"1fr 1fr", gap:24, marginBottom:24 }}>
              ...
              <div style={{ display:"flex", flexDirection:"column", gap:24 }}>
                <div style={{ background:C.surface, borderRadius:12, padding:"28px 24px 52px", position:"relative", border:"1px solid #4ade80", borderLeft:`4px solid #4ade80`, borderBottom:`3px solid #4ade80`, transition:"box-shadow .25s" }}>
                  ...
                  <a href="https://www.harborfoodservice.com" target="_blank" rel="noopener noreferrer"
                    style={{ position:"absolute", bottom:14, right:16, display:"inline-flex", alignItems:"center", gap:6, fontSize:13, fontWeight:700, letterSpacing:".1em", textTransform:"uppercase", color:"#fff", textDecoration:"none", background:C.blue, padding:"5px 12px", borderRadius:20 }}>
                    harborfoodservice.com <svg width="9" height="9" viewBox="0 0 10 10" fill="none"><polygon points="2,1 9,5 2,9" fill="currentColor"/></svg>
                  </a>
                </div>
                <div className="callout-left-blue" style={{ background:C.surface, borderRadius:"0 12px 12px 0", flex:1, position:"relative", padding:"18px 22px 52px", borderLeft:`3px solid ${C.blue}` }}>
            ...
            {/* PNW Bridge */}
            <div style={{ background:C.surface, borderRadius:"0 12px 12px 0", position:"relative", padding:"18px 22px 52px", border:"1px solid #4ade80", borderLeft:`4px solid #4ade80`, borderBottom:`3px solid #4ade80` }}>
              ...
              <p style={{ fontSize:14, color:C.muted, lineHeight:1.78 }}>
              ...
              <a
                ...
                style={{ position:"absolute", bottom:14, right:16, display:"inline-flex", alignItems:"center", gap:6, fontSize:13, fontWeight:700, letterSpacing:".1em", textTransform:"uppercase", color:"#1c1c1c", textDecoration:"none", background:"#4ade80", padding:"5px 12px", borderRadius:20 }}
              >
