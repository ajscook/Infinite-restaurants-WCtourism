...
import { GenButton } from "./PromptGenerator";
  ...
  return (
    <div style={{ borderBottom: `1px solid ${C.border}` }}>
      <button onClick={() => setOpen(o => !o)} style={{ width: "100%", background: "none", border: "none", cursor: "pointer", padding: "24px 0", textAlign: "left", display: "flex", alignItems: "flex-start", gap: 16 }}>
        ...
        <div style={{ width: 32, height: 32, flexShrink: 0, borderRadius: 6, border: `2px solid ${open ? accent : C.dim}`, display: "flex", alignItems: "center", justifyContent: "center", transition: "transform .3s,border-color .2s", transform: open ? "rotate(45deg)" : "none", color: open ? accent : C.muted, marginTop: 3 }}>
    ...
    <nav style={{ position: "sticky", top: 0, zIndex: 200, background: "rgba(13,15,20,.96)", backdropFilter: "blur(16px)", borderBottom: `1px solid ${C.border}` }}>
      <div style={{ ...W, display: "flex", alignItems: "center", justifyContent: "space-between", gap: 12, padding: "16px 120px", position: "relative" }}>
        ...
        <div className="nav-tabs-desktop">
          {[["who",<>Super<br/>Tourist</>],["where",<>Travel<br/>Patterns</>],["position",<>Your<br/>Position</>],["action",<>Prep<br/>Priorities</>],["ai",<>AI<br/>Prompts</>]].map(([id, label]) => (
  ...
  <section style={{ minHeight: "100vh", display: "flex", flexDirection: "column", justifyContent: "center", position: "relative", overflow: "hidden" }}>
    ...
    <div style={{ ...W, position: "relative", zIndex: 1, padding: "48px 120px 18px" }}>
      ...
      <h1 className="d u1" style={{ fontSize: "clamp(28px,5vw,64px)", fontWeight: 800, lineHeight: 1.0, letterSpacing: "-.03em", marginBottom: 28, color: C.text }}>
        <span style={{ color: C.text }}>It Isn't About </span><span style={{ color: C.blue }}>Soccer in Stadiums</span><br />
      ...
      <div className="u3" style={{ display:"flex", gap:14, alignItems:"center", marginBottom:48, flexWrap:"wrap" }}>
        <button
          onClick={() => document.getElementById("pattern")?.scrollIntoView({ behavior:"smooth" })}
...
const SWho = () => {
  ...
  <Sec id="who" num="01" label="The Super Tourist" accent={C.blue}>
    ...
    <p style={{ fontSize: 19, color: C.muted, fontWeight: 300, lineHeight: 1.78, marginBottom: 24, maxWidth: "90%" }}>
      Your town could be along their route whether you're planning for it or not... <strong style={{ color: C.orange }}>and we're going to be feeding and serving them for a month.</strong>
    </p>
          ...
          {[
            ...
            <button key={i} onClick={() => setModal(s.k)} style={{ padding: "16px 18px", borderTop: `1px solid ${C.border}`, borderRight: i%2===0?`1px solid ${C.border}`:"none", borderBottom:"none", borderLeft:"none", background:"none", cursor:"pointer", textAlign:"left", position:"relative", transition:"background .18s, box-shadow .18s, transform .15s" }}
              ...
              <div style={{ display:"flex", alignItems:"center", justifyContent:"space-between" }}>
                ...
                <div style={{ width:26, height:26, borderRadius:5, border:`2px solid ${s.c}`, background:modal===s.k?s.c:"transparent", display:"flex", alignItems:"center", justifyContent:"center", transition:"transform .3s,background .2s", transform:modal===s.k?"rotate(45deg)":"none", color:modal===s.k?"#fff":s.c, flexShrink:0 }}><svg width="12" height="12" viewBox="0 0 13 13" fill="none"><path d="M6.5 1v11M1 6.5h11" stroke="currentColor" strokeWidth="2" strokeLinecap="round"/></svg></div>
              </div>
  ...
  <div className={`pillar-card ${card.color==='#FF6700'?"card-orange":"card-blue"} ${isActive?"active":""}`} onClick={onToggle}>
    <div style={{ padding:"22px 20px 20px 20px", display:"flex", flexDirection:"column", height:"100%" }}>
      ...
      <div style={{ marginTop:"auto", paddingTop:16, display:"flex", justifyContent:"flex-end" }}>
        <div style={{ width:32, height:32, flexShrink:0, borderRadius:6, border:`2px solid ${isActive?card.color:C.dim}`, display:"flex", alignItems:"center", justifyContent:"center", transition:"transform .3s,border-color .2s", transform:isActive?"rotate(45deg)":"none", color:isActive?card.color:C.dim }}><svg width="13" height="13" viewBox="0 0 13 13" fill="none"><path d="M6.5 1v11M1 6.5h11" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round"/></svg></div>
      </div>
    </div>
  </div>
);
  ...
  <Sec id="where" num="02" label="Travel Patterns" accent={C.orange}>
    ...
    <div className="card-blue" style={{ background: C.surface, borderRadius: 12, marginTop:24, marginBottom: 24, overflow:"hidden" }}>
      ...
      <button onClick={() => setChainOpen(o => !o)} style={{ width:"100%", background:"none", border:"none", borderTop:`1px solid ${C.border}`, padding:"16px 28px", cursor:"pointer", display:"flex", alignItems:"center", justifyContent:"space-between", marginTop:16 }}>
        ...
        <div style={{ width:32, height:32, flexShrink:0, borderRadius:6, border:`2px solid ${chainOpen?C.orange:C.dim}`, display:"flex", alignItems:"center", justifyContent:"center", transition:"transform .3s,border-color .2s", transform:chainOpen?"rotate(45deg)":"none", color:chainOpen?C.orange:C.dim }}><svg width="13" height="13" viewBox="0 0 13 13" fill="none"><path d="M6.5 1v11M1 6.5h11" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round"/></svg></div>
      </button>
    </div>
...
const PositionCard = ({ card, isActive, onToggle }) => (
  <div className={`pillar-card ${card.color==='#FF6700'?"card-orange":"card-blue"} ${isActive?"active":""}`} onClick={onToggle}>
    <div style={{ padding:"22px 20px 20px 20px", display:"flex", flexDirection:"column", height:"100%" }}>
      ...
      <div style={{ marginTop:"auto", paddingTop:16, display:"flex", justifyContent:"flex-end" }}>
        <div style={{ width:32, height:32, flexShrink:0, borderRadius:6, border:`2px solid ${isActive?C.orange:C.dim}`, display:"flex", alignItems:"center", justifyContent:"center", transition:"transform .3s,border-color .2s", transform:isActive?"rotate(45deg)":"none", color:isActive?C.orange:C.dim }}><svg width="13" height="13" viewBox="0 0 13 13" fill="none"><path d="M6.5 1v11M1 6.5h11" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round"/></svg></div>
      </div>
    </div>
  </div>
);
...
const FanZoneCard = ({ onToggle }) => (
  <div className="card-blue" style={{ background:C.surface, borderRadius:12, cursor:"pointer", marginTop:24, padding:"20px 22px", display:"flex", flexDirection:"column" }} onClick={onToggle}>
    ...
    <div style={{ marginTop:"auto", display:"flex", justifyContent:"flex-end" }}>
        <div style={{ width:32, height:32, flexShrink:0, borderRadius:6, border:`1px solid ${C.dim}`, display:"flex", alignItems:"center", justifyContent:"center", color:C.dim }}><svg width="13" height="13" viewBox="0 0 13 13" fill="none"><path d="M6.5 1v11M1 6.5h11" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round"/></svg></div>
    </div>
  </div>
);
...
const SPosition = () => {
  ...
  <Sec id="position" num="03" label="Your Position" accent={C.blue}>
    ...
    <div className="callout-left-orange" style={{ marginTop:10, cursor:"pointer", display:"flex", flexDirection:"column" }} onClick={() => { setSfStaffOpen(o => !o); setFzOpen(false); setActive(null); }}>
      ...
      <div style={{ marginTop:"auto", display:"flex", justifyContent:"flex-end" }}>
        <div style={{ width:32, height:32, flexShrink:0, borderRadius:6, border:`2px solid ${sfStaffOpen?C.orange:C.dim}`, display:"flex", alignItems:"center", justifyContent:"center", transition:"transform .3s,border-color .2s", transform:sfStaffOpen?"rotate(45deg)":"none", color:sfStaffOpen?C.orange:C.dim }}><svg width="13" height="13" viewBox="0 0 13 13" fill="none"><path d="M6.5 1v11M1 6.5h11" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round"/></svg></div>
      </div>
    </div>
...
const PillarCard = ({ pillar, isActive, onToggle }) => (
  <div className={`pillar-card ${pillar.color==='#FF6700'?"card-orange":"card-blue"} ${isActive?"active":""}`} onClick={onToggle}>
    <div style={{ padding:"22px 20px 20px 20px", display:"flex", flexDirection:"column", height:"100%" }}>
      ...
      <div style={{ marginTop:"auto", paddingTop:16, display:"flex", justifyContent:"flex-end" }}>
        <div style={{ width:32, height:32, flexShrink:0, borderRadius:6, border:`2px solid ${isActive?pillar.color:C.dim}`, display:"flex", alignItems:"center", justifyContent:"center", transition:"transform .3s,border-color .2s", transform:isActive?"rotate(45deg)":"none", color:isActive?pillar.color:C.dim }}><svg width="13" height="13" viewBox="0 0 13 13" fill="none"><path d="M6.5 1v11M1 6.5h11" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round"/></svg></div>
      </div>
    </div>
  </div>
);
...
const SAI = () => {
  ...
  return (
    <Sec id="ai" num="05" label="AI Prompts" accent={C.blue}>
      <h2 className="d" style={{ fontSize:"clamp(28px,4.2vw,48px)", fontWeight:800, lineHeight:1.04, letterSpacing:"-.02em", marginBottom:20, color:C.text }}>
        <span style={{ color:C.text }}>This is where the </span><span style={{ color:C.blue }}>research</span><br/>
        <span style={{ color:C.text }}>becomes a </span><span style={{ color:C.orange }}>conversation.</span>
      </h2>
      <p style={{ fontSize:19, color:C.muted, fontWeight:300, lineHeight:1.78, marginBottom:24, maxWidth:"90%" }}>
        The platform did the research. The prompts below bring it into a focused conversation with your AI - scoped to your operation, your position, your decisions. Answer a few questions. Get a prompt built from your answers. Take it wherever you work.
      </p>

      {/* ── BRIEF YOUR AI ── card-blue, SAbout pattern */}
      <button onClick={() => setBriefOpen(o => !o)} style={{ width:"100%", background:"none", border:"none", cursor:"pointer", padding:0, display:"block", textAlign:"left" }}>
        <div className="card-blue" style={{ background:C.surface, borderRadius:12, padding:"24px 28px", display:"flex", alignItems:"center", justifyContent:"space-between", gap:24 }}>
          <div>
            <div style={{ fontSize:11, fontWeight:700, letterSpacing:".18em", textTransform:"uppercase", color:C.blue, marginBottom:6 }}>AI Research Brief</div>
            <div className="d" style={{ fontSize:"clamp(17px,2.4vw,22px)", fontWeight:700, color:C.text, lineHeight:1.2 }}>Brief Your AI</div>
            <p style={{ fontSize:15, color:C.muted, lineHeight:1.7, marginTop:6, marginBottom:0, maxWidth:520 }}>Seven questions. Your AI comes back knowing your restaurant and what the World Cup means for it specifically - then opens a planning conversation already loaded with what it found.</p>
          </div>
          <div style={{ width:44, height:44, flexShrink:0, borderRadius:8, border:`2px solid ${briefOpen?C.blue:C.dim}`, display:"flex", alignItems:"center", justifyContent:"center", transition:"transform .3s,border-color .2s", transform:briefOpen?"rotate(45deg)":"none", color:briefOpen?C.blue:C.dim }}>
      ...
      <div className={`xbody ${briefOpen?"open":""}`}>
        <div style={{ padding:"24px 4px 8px", display:"flex", flexDirection:"column", gap:14 }}>
          <p style={{ fontSize:16, color:C.muted, lineHeight:1.78 }}>Answer seven questions about your restaurant - address, setup, hours flexibility, inventory position. The generator builds two prompts from what you tell it.</p>
          <p style={{ fontSize:16, color:C.muted, lineHeight:1.78 }}>The first prompt goes to your AI in deep research mode. It comes back with a profile of your operation against the tournament data - where you sit in the surge geography, where your real pressure points are, what decisions you haven't made yet. Read it. That's your context.</p>
          <p style={{ fontSize:16, color:C.muted, lineHeight:1.78 }}>The second prompt opens the planning conversation already loaded with that context. Your AI isn't starting cold. You're not explaining your situation from scratch. You pick up where the research left off.</p>
          <div style={{ display:"flex", alignItems:"center", gap:14, flexWrap:"wrap", paddingTop:4 }}>
            <GenButton generatorId="world_cup_research" label="Build My Prompts" />
            <span style={{ fontSize:13, color:C.dim }}>Generates both prompts at once.</span>
          </div>
        </div>
      </div>

      {/* ── ONE-SHOT PROMPT GENERATORS ── card-blue */}
      <div style={{ marginTop:16 }}>
        <button onClick={() => setShotsOpen(o => !o)} style={{ width:"100%", background:"none", border:"none", cursor:"pointer", padding:0, display:"block", textAlign:"left" }}>
          <div className="card-blue" style={{ background:C.surface, borderRadius:12, padding:"24px 28px", display:"flex", alignItems:"center", justifyContent:"space-between", gap:24 }}>
            <div>
              <div style={{ fontSize:11, fontWeight:700, letterSpacing:".18em", textTransform:"uppercase", color:C.blue, marginBottom:6 }}>One-Shot Prompt Generators</div>
              <div className="d" style={{ fontSize:"clamp(17px,2.4vw,22px)", fontWeight:700, color:C.text, lineHeight:1.2 }}>Focused conversation starters</div>
              <p style={{ fontSize:15, color:C.muted, lineHeight:1.7, marginTop:6, marginBottom:0, maxWidth:520 }}>Sorted by the four prep pillars. Pick the one that's most urgent, get a prompt scoped to that topic, take it into whichever AI platform you use.</p>
            </div>
            <div style={{ width:44, height:44, flexShrink:0, borderRadius:8, border:`2px solid ${shotsOpen?C.blue:C.dim}`, display:"flex", alignItems:"center", justifyContent:"center", transition:"transform .3s,border-color .2s", transform:shotsOpen?"rotate(45deg)":"none", color:shotsOpen?C.blue:C.dim }}>
              <svg width="14" height="14" viewBox="0 0 13 13" fill="none"><path d="M6.5 1v11M1 6.5h11" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round"/></svg>
            </div>
          </div>
        </button>
      ...
      {/* ── HI-AI-HI ── callout-left-orange expandable */}
      <div style={{ marginTop:16 }}>
        <button onClick={() => setHiOpen(o => !o)} style={{ width:"100%", background:"none", border:"none", cursor:"pointer", padding:0, display:"block", textAlign:"left" }}>
          <div className="callout-left-orange" style={{ background:C.surface, borderRadius:"0 12px 12px 0", display:"flex", alignItems:"center", justifyContent:"space-between", gap:24 }}>
            <div>
              <div style={{ display:"flex", alignItems:"center", gap:8, marginBottom:8 }}>
                {["HI","AI","HI"].map((t,i) => (
                  <div key={i} style={{ background: t==="AI" ? C.orange : C.surf2, border:`1px solid ${t==="AI"?C.orange:C.border}`, borderRadius:5, padding:"4px 8px" }}>
                    <span className="n" style={{ fontSize:12, fontWeight:700, color: t==="AI" ? "white" : C.dim }}>{t}</span>
                  </div>
                ))}
              </div>
              <div className="d" style={{ fontSize:"clamp(17px,2.4vw,22px)", fontWeight:700, color:C.text, lineHeight:1.2 }}>Philosophy, Platforms &amp; Reading the Output</div>
              <p style={{ fontSize:15, color:C.muted, lineHeight:1.7, marginTop:6, marginBottom:0, maxWidth:520 }}>How this platform thinks about AI, which tools to use, and how to know when to trust what comes back.</p>
            </div>
            <div style={{ width:44, height:44, flexShrink:0, borderRadius:8, border:`2px solid ${hiOpen?C.orange:C.dim}`, display:"flex", alignItems:"center", justifyContent:"center", transition:"transform .3s,border-color .2s", transform:hiOpen?"rotate(45deg)":"none", color:hiOpen?C.orange:C.dim }}>
              <svg width="14" height="14" viewBox="0 0 13 13" fill="none"><path d="M6.5 1v11M1 6.5h11" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round"/></svg>
            </div>
          </div>
        </button>
        <div className={`xbody ${hiOpen?"open":""}`}>
          <div style={{ paddingTop:24, paddingBottom:8, display:"flex", flexDirection:"column", gap:22 }}>
            <p style={{ fontSize:16, color:C.text, lineHeight:1.82 }}>
            ...
            <p style={{ fontSize:16, color:C.muted, lineHeight:1.82 }}>
            ...
            <div className="callout-left-blue">
              ...
              <p style={{ fontSize:16, color:C.text, lineHeight:1.75, fontWeight:600, margin:0 }}>If something feels off or seems wrong, it probably is. Pull that thread. Verify it. Your instincts are not a liability in an AI workflow. They are the first gate and the last gate. Don't surrender them.</p>
            </div>
            <div>
                ...
                {aiPlatforms.map((p,i) => (
                  <div key={i} style={{ borderBottom: i<aiPlatforms.length-1?`1px solid ${C.border}`:"none" }}>
                    <button onClick={() => setActivePlatform(activePlatform===i?null:i)} style={{ width:"100%", background:"none", border:"none", cursor:"pointer", padding:"14px 18px", display:"flex", alignItems:"center", justifyContent:"space-between", textAlign:"left" }}>
                      ...
                      <div style={{ width:28, height:28, flexShrink:0, borderRadius:5, border:`1px solid ${activePlatform===i?C.blue:C.dim}`, display:"flex", alignItems:"center", justifyContent:"center", transition:"transform .3s,border-color .2s", transform:activePlatform===i?"rotate(45deg)":"none", color:activePlatform===i?C.blue:C.dim }}><svg width="11" height="11" viewBox="0 0 13 13" fill="none"><path d="M6.5 1v11M1 6.5h11" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round"/></svg></div>
                    </button>
  ...
  return (
    <div style={{ borderBottom:`1px solid ${C.border}` }}>
      <button onClick={onToggle} style={{ width:"100%", background:"none", border:"none", cursor:"pointer", padding:"16px 20px", display:"flex", alignItems:"flex-start", justifyContent:"space-between", textAlign:"left", gap:16 }}>
        ...
        <div style={{ width:28, height:28, flexShrink:0, borderRadius:5, border:`1px solid ${isOpen?C.blue:C.dim}`, display:"flex", alignItems:"center", justifyContent:"center", transition:"transform .3s,border-color .2s", transform:isOpen?"rotate(45deg)":"none", color:isOpen?C.blue:C.dim }}><svg width="11" height="11" viewBox="0 0 13 13" fill="none"><path d="M6.5 1v11M1 6.5h11" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round"/></svg></div>
      </button>
...
<div style={{ width:32, height:32, flexShrink:0, borderRadius:6, border:`2px solid ${open?accent:C.dim}`, display:"flex", alignItems:"center", justifyContent:"center", transition:"transform .3s,border-color .2s", transform:open?"rotate(45deg)":"none", color:open?accent:C.dim }}><svg width="13" height="13" viewBox="0 0 13 13" fill="none"><path d="M6.5 1v11M1 6.5h11" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round"/></svg></div>
    </button>
  );
                ...
                <div key={i} style={{ borderBottom: i<methodologies.length-1?`1px solid ${C.border}`:"none" }}>
                  <details>
                    <summary style={{ padding:"16px 20px", fontSize:14, fontWeight:700, color:C.text, cursor:"pointer", listStyle:"none", display:"flex", justifyContent:"space-between", alignItems:"center", background:C.surface }}>
                      {m.title}
                      <div style={{ width:24, height:24, flexShrink:0, borderRadius:5, border:`1px solid ${C.dim}`, display:"flex", alignItems:"center", justifyContent:"center", color:C.dim, marginLeft:12 }}><svg width="11" height="11" viewBox="0 0 13 13" fill="none"><path d="M6.5 1v11M1 6.5h11" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round"/></svg></div>
                    </summary>
            ...
            <div>
              <button onClick={() => setSrcOpen(o => !o)} style={{ width:"100%", background:"none", border:"none", cursor:"pointer", textAlign:"left", display:"flex", alignItems:"center", justifyContent:"space-between", marginBottom: srcOpen ? 16 : 0, padding:0 }}>
                ...
                <div style={{ display:"flex", alignItems:"center", gap:8, fontSize:14, fontWeight:700, letterSpacing:".1em", textTransform:"uppercase", color:C.dim }}>
                  ...
                  <div style={{ width:28, height:28, flexShrink:0, borderRadius:5, border:`1px solid ${srcOpen?C.blue:C.dim}`, display:"flex", alignItems:"center", justifyContent:"center", transition:"transform .3s,border-color .2s", transform:srcOpen?"rotate(45deg)":"none", color:srcOpen?C.blue:C.dim }}><svg width="11" height="11" viewBox="0 0 13 13" fill="none"><path d="M6.5 1v11M1 6.5h11" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round"/></svg></div>
                </div>
              </button>
      ...
      <div id="about" style={{ marginTop:24 }}>
        ...
        >
          ...
          >
            ...
            <div style={{ width:44, height:44, flexShrink:0, borderRadius:8, border:`2px solid ${aboutOpen ? C.blue : C.border}`, display:"flex", alignItems:"center", justifyContent:"center", transition:"transform .3s, border-color .2s", transform:aboutOpen?"rotate(45deg)":"none", color:open?C.blue:C.dim }}>
              <svg width="14" height="14" viewBox="0 0 13 13" fill="none"><path d="M6.5 1v11M1 6.5h11" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round"/></svg>
            </div>
          </div>
        </button>
