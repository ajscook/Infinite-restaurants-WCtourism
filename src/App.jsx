  ...
  <div className={`pillar-card ${card.color==='#FF6700'?"card-orange":"card-blue"} ${isActive?"active":""}`} onClick={onToggle}>
    <div style={{ padding:"22px 20px 20px 20px", display:"flex", flexDirection:"column", height:"100%" }}>
      ...
      <div style={{ marginTop:"auto", paddingTop:16, display:"flex", justifyContent:"flex-end", paddingRight:4 }}>
        <div style={{ width:32, height:32, flexShrink:0, borderRadius:6, border:`2px solid ${C.orange}`, display:"flex", alignItems:"center", justifyContent:"center", transition:"transform .3s,border-color .2s", transform:isActive?"rotate(45deg)":"none", color:C.orange }}><svg width="13" height="13" viewBox="0 0 13 13" fill="none"><path d="M6.5 1v11M1 6.5h11" stroke="currentColor" strokeWidth="2.2" strokeLinecap="round"/></svg></div>
      </div>
    </div>
  </div>
);
...
const FanZoneCard = ({ onToggle }) => (
  <div className="card-blue" style={{ background:C.surface, borderRadius:12, cursor:"pointer", marginTop:24, padding:"20px 22px", display:"flex", flexDirection:"column" }} onClick={onToggle}>
    ...
    <div style={{ marginTop:"auto", display:"flex", justifyContent:"flex-end" }}>
        <div style={{ width:32, height:32, flexShrink:0, borderRadius:6, border:`2px solid ${C.orange}`, display:"flex", alignItems:"center", justifyContent:"center", color:C.orange }}><svg width="13" height="13" viewBox="0 0 13 13" fill="none"><path d="M6.5 1v11M1 6.5h11" stroke="currentColor" strokeWidth="2.2" strokeLinecap="round"/></svg></div>
    </div>
  </div>
);
...
const SPosition = () => {
  ...
  <Sec id="position" num="03" label="Your Position" accent={C.blue}>
    ...
    <div className="callout-left-orange" style={{ marginTop:10, cursor:"pointer", display:"flex", flexDirection:"column" }} onClick={() => { setSfStaffOpen(o => !o); setFzOpen(false); setActive(null); }}>
      ...
      <div style={{ marginTop:"auto", display:"flex", justifyContent:"flex-end" }}>
        <div style={{ width:32, height:32, flexShrink:0, borderRadius:6, border:`2px solid ${C.blue}`, display:"flex", alignItems:"center", justifyContent:"center", transition:"transform .3s,border-color .2s", transform:sfStaffOpen?"rotate(45deg)":"none", color:C.blue }}><svg width="13" height="13" viewBox="0 0 13 13" fill="none"><path d="M6.5 1v11M1 6.5h11" stroke="currentColor" strokeWidth="2.2" strokeLinecap="round"/></svg></div>
      </div>
    </div>
...
const SFCard = ({ isActive, onToggle }) => (
  <div className="callout-left-orange" style={{ cursor:"pointer", display:"flex", flexDirection:"column" }} onClick={onToggle}>
    ...
    <div style={{ marginTop:"auto", display:"flex", justifyContent:"flex-end" }}>
      <div style={{ width:32, height:32, flexShrink:0, borderRadius:6, border:`2px solid ${C.blue}`, display:"flex", alignItems:"center", justifyContent:"center", transition:"transform .3s,border-color .2s", transform:isActive?"rotate(45deg)":"none", color:C.blue }}><svg width="13" height="13" viewBox="0 0 13 13" fill="none"><path d="M6.5 1v11M1 6.5h11" stroke="currentColor" strokeWidth="2.2" strokeLinecap="round"/></svg></div>
    </div>
  </div>
);
...
const SAI = () => {
  ...
  return (
    <Sec id="ai" num="05" label="HI ∞ AI ∞ HI Prompts" accent={C.blue}>
      ...
      <button onClick={() => { setBriefOpen(true); setBriefStep(1); }} style={{ width:"100%", background:"none", border:"none", cursor:"pointer", padding:0, display:"block", textAlign:"left" }}>
        ...
        <div onClick={() => setBriefOpen(false)} style={{ position:"fixed", inset:0, background:"rgba(0,0,0,.78)", zIndex:500, display:"flex", alignItems:"center", justifyContent:"center", padding:24, backdropFilter:"blur(4px)", animation:"in .18s ease" }}>
          <div onClick={e => e.stopPropagation()} style={{ background:C.surface, border:`2px solid ${C.blue}`, borderRadius:14, width:"100%", maxWidth:720, maxHeight:"88vh", display:"flex", flexDirection:"column", boxShadow:"0 24px 64px rgba(0,0,0,.6)", overflow:"hidden" }}>
            ...
            <div style={{ padding:"18px 24px", borderBottom:`1px solid ${C.border}`, display:"flex", alignItems:"center", justifyContent:"space-between", flexShrink:0, background:C.surface }}>
              <div style={{ display:"flex", alignItems:"center", gap:16 }}>
                ...
                <span style={{ fontSize:11, fontWeight:700, letterSpacing:".14em", textTransform:"uppercase", color:C.dim }}>
                  {briefStep===1 ? "What to expect" : briefStep===2 ? "Your context" : briefStep===3 ? "Prompt 1" : briefStep===4 ? "Your move" : briefStep===5 ? "Prompt 2" : briefStep===6 ? "Your move" : "Prompt 3"}
                </span>
              </div>
              ...
              {briefStep===1 && (
                <div style={{ display:"flex", flexDirection:"column", gap:16 }}>
                  <div style={{ borderLeft:`3px solid ${C.blue}`, paddingLeft:18 }}>
                    ...
                    <p style={{ fontSize:18, color:C.muted, lineHeight:1.82, marginBottom:16 }}>Your AI platform already "kinda/mostly knows" you and your restaurant, it knows your preferences and what's nonnegotiable. These prompts are for the other half: the tournament research mapped to your specific restaurant, market, regulations, and opportunities. When these meet inside the platform(s) that already has your context, the noise drops. What's left is a more specific, more disciplined conversation than your AI would find on its own.</p>
                    <p style={{ fontSize:22, color:C.text, fontWeight:800, textTransform:"uppercase", lineHeight:1.3, marginBottom:10 }}>Context is Key.</p>
                    <p style={{ fontSize:18, color:C.muted, lineHeight:1.82, margin:0 }}>Starts with seven questions to build a structured outline of your operation that rides into all three prompts. The more complete your answers, the more specific the research and conversation that follows.</p>
                  </div>
                </div>
              )}
            ...
            <div style={{ padding:"16px 24px", borderTop:`1px solid ${C.border}`, display:"flex", alignItems:"center", justifyContent:"space-between", flexShrink:0, background:C.surface }}>
              <button onClick={() => setBriefStep(s => Math.max(1, s-1))} disabled={briefStep===1} style={{ background:"none", border:`1px solid ${briefStep===1?C.border:C.dim}`, borderRadius:20, padding:"7px 18px", cursor:briefStep===1?"default":"pointer", fontSize:13, fontWeight:700, letterSpacing:".08em", textTransform:"uppercase", color:briefStep===1?C.border:C.muted, fontFamily:"'Jost',sans-serif", transition:"all .15s" }}>
                Back
              </button>
              <span style={{ fontSize:11, fontWeight:700, letterSpacing:".14em", textTransform:"uppercase", color:C.dim }}>{briefStep} of 7</span>
              {briefStep < 7
                ? <button onClick={() => setBriefStep(s => s+1)} style={{ background:C.blue, border:`1px solid ${C.blue}`, borderRadius:20, padding:"7px 18px", cursor:"pointer", fontSize:13, fontWeight:700, letterSpacing:".08em", textTransform:"uppercase", color:"#fff", fontFamily:"'Jost',sans-serif" }}>Next</button>
                : <button onClick={() => setBriefOpen(false)} style={{ background:C.orange, border:`1px solid ${C.orange}`, borderRadius:20, padding:"7px 18px", cursor:"pointer", fontSize:13, fontWeight:700, letterSpacing:".08em", textTransform:"uppercase", color:"#fff", fontFamily:"'Jost',sans-serif" }}>Done</button>
              }
            </div>
      ...
      <div style={{ marginTop:16 }}>
        <button onClick={() => setShotsOpen(o => !o)} style={{ width:"100%", background:"none", border:"none", cursor:"pointer", padding:0, display:"block", textAlign:"left" }}>
          <div className="card-blue" style={{ background:C.surface, borderRadius:12, padding:"20px 22px", display:"flex", flexDirection:"column" }}>
            ...
            <div style={{ marginTop:"auto", display:"flex", justifyContent:"flex-end" }}>
              <div style={{ width:32, height:32, flexShrink:0, borderRadius:6, border:`2px solid ${C.orange}`, display:"flex", alignItems:"center", justifyContent:"center", transition:"transform .3s,border-color .2s", transform:shotsOpen?"rotate(45deg)":"none", color:C.orange }}><svg width="13" height="13" viewBox="0 0 13 13" fill="none"><path d="M6.5 1v11M1 6.5h11" stroke="currentColor" strokeWidth="2.2" strokeLinecap="round"/></svg></div>
            </div>
          </div>
        </button>
      ...
      <div style={{ marginTop:16 }}>
        <div className="card-orange" style={{ background:C.surface, borderRadius:12, cursor:"pointer", padding:"20px 22px", display:"flex", flexDirection:"column" }} onClick={() => setFurtherOpen(o => !o)}>
          ...
          <div style={{ marginTop:"auto", display:"flex", justifyContent:"flex-end" }}>
            <div style={{ width:32, height:32, flexShrink:0, borderRadius:6, border:`2px solid ${C.blue}`, display:"flex", alignItems:"center", justifyContent:"center", transition:"transform .3s", transform:furtherOpen?"rotate(45deg)":"none", color:C.blue }}><svg width="13" height="13" viewBox="0 0 13 13" fill="none"><path d="M6.5 1v11M1 6.5h11" stroke="currentColor" strokeWidth="2.2" strokeLinecap="round"/></svg></div>
          </div>
        </div>
      ...
      <div style={{ marginTop:16 }}>
        <div className="callout-left-blue" style={{ background:C.surface, borderRadius:"0 12px 12px 0", cursor:"pointer", display:"flex", flexDirection:"column" }} onClick={() => setHiOpen(o => !o)}>
          ...
          <div style={{ marginTop:"auto", display:"flex", justifyContent:"flex-end" }}>
            <div style={{ width:32, height:32, flexShrink:0, borderRadius:6, border:`2px solid ${C.orange}`, display:"flex", alignItems:"center", justifyContent:"center", transition:"transform .3s", transform:hiOpen?"rotate(45deg)":"none", color:C.orange }}><svg width="13" height="13" viewBox="0 0 13 13" fill="none"><path d="M6.5 1v11M1 6.5h11" stroke="currentColor" strokeWidth="2.2" strokeLinecap="round"/></svg></div>
          </div>
        </div>
...
const SAction = () => {
  ...
  return (
    <Sec id="action" num="04" label="Prep Priorities" accent={C.orange}>
      <h2 className="d" style={{ fontSize:"clamp(28px,4.2vw,48px)", fontWeight:800, lineHeight:1.04, letterSpacing:"-.02em", marginBottom:20, color:C.text }}>
        <span style={{ color: C.text }}>Better beats </span><span style={{ color: C.orange }}>perfect</span><span style={{ color: C.text }}>.</span><br /><span style={{ color: C.text }}>You'll keep the </span><span style={{ color: C.blue }}>Improvements</span><span style={{ color: C.text }}>.</span>
      </h2>
      <p style={{ fontSize:19, color:C.muted, fontWeight:300, lineHeight:1.78, marginBottom:12, maxWidth: "90%" }}>
        Food, labor, operations, tech. You run these four things every shift. What's different is who's walking in, how they found you, and what happens to your staffing and supply chain while they're here. Millions more on the roads moving through North America for over a month puts pressure on all four at the same time. Your staff, shelves, hours, tech; may not be ready for this. The cards below are organized around where the pressure actually lands. Start with the one that makes you more nervous than the others.
      </p>
...
<div style={{ width:32, height:32, flexShrink:0, borderRadius:6, border:`2px solid ${accent===C.blue?C.orange:C.blue}`, display:"flex", alignItems:"center", justifyContent:"center", transition:"transform .3s,border-color .2s", transform:open?"rotate(45deg)":"none", color:accent===C.blue?C.orange:C.blue }}><svg width="13" height="13" viewBox="0 0 13 13" fill="none"><path d="M6.5 1v11M1 6.5h11" stroke="currentColor" strokeWidth="2.2" strokeLinecap="round"/></svg></div>
    </button>
  );
