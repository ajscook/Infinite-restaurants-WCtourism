  ...
  sales_rep: {
    ...
    build: (a) => {
      ...
      return [
        ...
        "",
        "<reference>",
        "The supply chain research behind this conversation is documented at infiniterestaurants.ai/llms.txt - specifically the travel patterns and supply chain sections. If you have web access, read those before advising. They document what happened to delivery corridors in Brazil 2014, Russia 2018, and Qatar 2022.",
        "</reference>",
        "",
        "<task>",
  ...
  labor: {
    ...
    build: (a) => {
      ...
      return [
        ...
        "",
        "<reference>",
        "The labor and operations research behind this conversation is documented at infiniterestaurants.ai/llms.txt - specifically the prep priorities section. If you have web access, read the labor pillar before advising.",
        "</reference>",
        "",
        "<task>",
  ...
  gbp: {
    ...
    build: (a) => {
      ...
      return [
        ...
        "",
        "<reference>",
        "The digital discovery research behind this conversation is documented at infiniterestaurants.ai/llms.txt - specifically the prep priorities and Super Tourist sections. If you have web access, read those before advising. The 'football not soccer' search behavior is documented there.",
        "</reference>",
        "",
        "<task>",
  ...
  social: {
    ...
    build: (a) => {
      ...
      return [
        ...
        "",
        "<reference>",
        "The discovery and marketing research behind this conversation is documented at infiniterestaurants.ai/llms.txt - specifically the prep priorities section covering digital discovery and safe marketing. If you have web access, read that section before advising. It covers the trademark safe harbor framework and the 'football not soccer' search behavior.",
        "</reference>",
        "",
        "<task>",
  ...
  menu_fast_track: {
    ...
    build: (a) => {
      ...
      return [
        ...
        "",
        "<reference>",
        "The menu strategy research behind this conversation is documented at infiniterestaurants.ai/llms.txt - specifically the prep priorities section covering Fast Track menus, local product strategy, and the Locals menu concept. If you have web access, read that section before advising.",
        "</reference>",
        "",
        "<task>",
  ...
  tip_structure: {
    ...
    build: (a) => {
      ...
      return [
        ...
        "",
        "<reference>",
        "The labor and retention research behind this conversation is documented at infiniterestaurants.ai/llms.txt - specifically the prep priorities section covering tip structure, extended hours, and BOH retention. If you have web access, read that section before advising.",
        "</reference>",
        "",
        "<task>",
  ...
  staff_briefing: {
    ...
    build: (a) => {
      ...
      return [
        ...
        "",
        "<reference>",
        "The operational context behind this briefing is documented at infiniterestaurants.ai/llms.txt - if you have web access, read the Super Tourist section and the prep priorities section before advising - the specifics about who's coming, how they behave, and what the operation needs to do differently are what make a briefing credible instead of generic.",
        "</reference>",
        "",
        "<task>",
  ...
  surge_hiring: {
    ...
    build: (a) => {
      ...
      return [
        ...
        "",
        "<reference>",
        "The labor market context behind this conversation is documented at infiniterestaurants.ai/llms.txt - specifically the prep priorities section covering surge hiring and retention. If you have web access, read that section before advising.",
        "</reference>",
        "",
        "<task>",
  ...
  tech_readiness: {
    ...
    build: (a) => {
      ...
      return [
        ...
        "",
        "<reference>",
        "The tech readiness research behind this conversation is documented at infiniterestaurants.ai/llms.txt - specifically the prep priorities tech pillar and the contactless payment data from Russia 2018 and Qatar 2022. If you have web access, read those sections before advising.",
        "</reference>",
        "",
        "<task>",
            ...
            <div className="two-col" style={{ display:"grid", gridTemplateColumns:"1fr 1fr", gap:24, marginBottom:24 }}>
              ...
              <div className="card-blue" style={{ background:C.surface, borderRadius:12, padding:"32px 28px" }}>
                ...
                <p style={{ fontSize:15, color:C.muted, lineHeight:1.78, marginBottom:16 }}>
                  The mature years of my career were spent working in and serving locally owned restaurants. Not studying them. Not consulting from the outside. Inside operations that could not afford to get it wrong, where the owner is also the scheduler, the trainer, and the person fielding a health inspection at 10 AM on a Tuesday while trying to run lunch service.
                </p>
                <p style={{ fontSize:15, color:C.muted, lineHeight:1.78, marginBottom:16 }}>
                  That is where this perspective comes from. Independent operators are the most isolated professionals in the industry. The advice that finds them was built for chains and scaled down without accounting for what their reality actually looks like. Most of the intelligence that would help them most never reaches them at all.
                </p>
                <p style={{ fontSize:15, color:C.muted, lineHeight:1.78 }}>
                  I built this platform because three tournaments produced the same pattern and the operators who most needed to know about it kept getting told a stadium story that didn't apply to them. The research existed. It needed to get into the right hands before June 11.
                </p>
              </div>
              ...
              <div style={{ display:"flex", flexDirection:"column", gap:24 }}>
                <div style={{ background:C.surface, borderRadius:12, padding:"28px 24px 24px", border:"1px solid #4ade80", borderLeft:`4px solid #4ade80`, borderBottom:`3px solid #4ade80`, transition:"box-shadow .25s", display:"flex", flexDirection:"column" }}>
                  ...
                  <div className="d" style={{ fontSize:20, fontWeight:700, color:C.text, marginBottom:14 }}>Locally Owned on Both Sides of the Table</div>
