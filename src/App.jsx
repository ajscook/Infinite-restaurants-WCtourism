...
const Hero = ({ onContinue }) => (
  <section style={{ minHeight: "100vh", display: "flex", flexDirection: "column", justifyContent: "flex-start", paddingTop: "10vh", position: "relative", overflow: "hidden" }}>
    ...
    <div style={{ ...W, position: "relative", zIndex: 1, padding: "48px 120px 18px" }}>
      ...
      <div className="u2" style={{ marginBottom: 48, maxWidth: "90%" }}>
        ...
        <p style={{ fontSize: "clamp(17px,2vw,20px)", fontWeight: 700, color: C.yellow, lineHeight: 1.6, marginBottom: 14, textTransform: "uppercase", letterSpacing: ".06em" }}>
...
const SWho = () => {
  ...
  <Sec id="who" num="01" label="The Super Tourist" accent={C.blue}>
    ...
    <p style={{ fontSize: 19, fontWeight: 700, letterSpacing: ".1em", textTransform: "uppercase", color: C.yellow, marginBottom: 6, maxWidth: "90%" }}>
      The host cities can't contain them.
    </p>
...
const SPosition = () => {
  ...
  <Sec id="position" num="03" label="Your Position" accent={C.blue}>
    ...
    <div style={{ marginTop:10, cursor:"pointer", display:"flex", flexDirection:"column", padding:"18px 22px", border:"1px solid #2e3d50", borderLeft:"3px solid #FFD600", borderRadius:"0 10px 10px 0" }} onClick={() => { setSfStaffOpen(o => !o); setFzOpen(false); setActive(null); }}>
      ...
      <div style={{ marginTop:"auto", display:"flex", justifyContent:"flex-end" }}>
        <div style={{ width:32, height:32, flexShrink:0, borderRadius:6, border:"2px solid #FFD600", display:"flex", alignItems:"center", justifyContent:"center", transition:"transform .3s,border-color .2s", transform:sfStaffOpen?"rotate(45deg)":"none", color:"#FFD600" }}><svg width="13" height="13" viewBox="0 0 13 13" fill="none"><path d="M6.5 1v11M1 6.5h11" stroke="currentColor" strokeWidth="2.2" strokeLinecap="round"/></svg></div>
      </div>
    </div>
...
const SAction = () => {
  ...
  return (
    <Sec id="action" num="04" label="Prep Priorities" accent={C.orange}>
      ...
      <p style={{ fontSize:14, color:C.yellow, marginBottom:24, letterSpacing:".1em", textTransform:"uppercase", fontWeight:700 }}>
