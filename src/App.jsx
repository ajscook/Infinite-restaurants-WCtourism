...
const SecLabel = ({ children, color = C.dim }) => (
  <div style={{ fontFamily: "'Jost',sans-serif", fontSize:18, fontWeight: 700, letterSpacing: ".14em", textTransform: "uppercase", color: C.text, marginBottom: 20, display: "flex", alignItems: "center", gap: 8 }}>
  ...
  <section style={{ display: "flex", flexDirection: "column", justifyContent: "flex-start", padding: "clamp(40px,8vh,100px) 0 clamp(24px,4vh,48px)", position: "relative", overflow: "hidden" }}>
    ...
    <div style={{ ...W, position: "relative", zIndex: 1, padding: "48px 120px 18px" }}>
      ...
      <h1 className="d u1" style={{ fontSize: "clamp(28px,5vw,64px)", fontWeight: 800, lineHeight: 1.0, letterSpacing: "-.03em", marginBottom: 28, color: C.text }}>
        <span style={{ color: C.text }}>It Isn't About </span><span style={{ color: C.blue }}>Soccer in Stadiums</span><span style={{ color: C.text }}>.</span><br />
      ...
      <div className="u2" style={{ marginBottom: 48, maxWidth: "90%" }}>
        ...
        <p style={{ fontSize: "clamp(17px,2vw,20px)", fontWeight: 700, color: C.text, lineHeight: 1.6, marginBottom: 14, textTransform: "uppercase", letterSpacing: ".06em" }}>Three tournaments, the same pattern:</p>
...
const SWho = () => {
  ...
  <Sec id="who" num="01" label="The Super Tourist" accent={C.blue}>
    ...
    <p style={{ fontSize: 19, fontWeight: 700, letterSpacing: ".1em", textTransform: "uppercase", color: C.text, marginBottom: 6, maxWidth: "90%" }}>The host cities can't contain them.</p>
    <p style={{ fontSize: 19, color: C.muted, fontWeight: 300, lineHeight: 1.78, marginBottom: 24, maxWidth: "90%" }}>
      Your town could be along their route whether you're planning for it or not... <strong><em style={{ color: C.blue, fontWeight: 700 }}>and we're going to be feeding and serving them for a month.</em></strong>
    </p>
...
const supplyCards = [
  { id:"rep", letter:"R", label:"Distributor Plan", sub:"Coordinate & plan with your supply chain", color:C.blue,
  ...
  <div className={`pillar-card ${card.color==='#FF6700'?"card-orange":"card-blue"} ${isActive?"active":""}`} onClick={onToggle}>
    <div style={{ padding:"22px 20px 20px 20px", display:"flex", flexDirection:"column", height:"100%" }}>
      ...
      <div style={{ marginTop:"auto", paddingTop:16, display:"flex", justifyContent:"flex-end" }}>
        <div style={{ width:32, height:32, flexShrink:0, borderRadius:6, border:`2px solid ${isActive?card.color:card.color}`, display:"flex", alignItems:"center", justifyContent:"center", transition:"transform .3s,border-color .2s", transform:isActive?"rotate(45deg)":"none", color:isActive?card.color:card.color }}><svg width="13" height="13" viewBox="0 0 13 13" fill="none"><path d="M6.5 1v11M1 6.5h11" stroke="currentColor" strokeWidth="2.2" strokeLinecap="round"/></svg></div>
      </div>
    </div>
  </div>
);
  ...
  <Sec id="where" num="02" label="Travel Patterns" accent={C.orange}>
    ...
    <div className="card-blue" style={{ background: C.surface, borderRadius: 12, marginTop:24, marginBottom: 24, overflow:"hidden" }}>
      ...
      <button onClick={() => setChainOpen(o => !o)} style={{ width:"100%", background:"none", border:"none", borderTop:`1px solid ${C.border}`, padding:"16px 28px", cursor:"pointer", display:"flex", alignItems:"center", justifyContent:"space-between", marginTop:16 }}>
        ...
        <div style={{ width:32, height:32, flexShrink:0, borderRadius:6, border:`2px solid ${chainOpen?C.orange:C.orange}`, display:"flex", alignItems:"center", justifyContent:"center", transition:"transform .3s,border-color .2s", transform:chainOpen?"rotate(45deg)":"none", color:chainOpen?C.orange:C.orange }}><svg width="13" height="13" viewBox="0 0 13 13" fill="none"><path d="M6.5 1v11M1 6.5h11" stroke="currentColor" strokeWidth="2.2" strokeLinecap="round"/></svg></div>
      </button>
    </div>
...
const PositionCard = ({ card, isActive, onToggle }) => (
  <div className={`pillar-card ${card.color==='#FF6700'?"card-orange":"card-blue"} ${isActive?"active":""}`} onClick={onToggle}>
    <div style={{ padding:"22px 20px 20px 20px", display:"flex", flexDirection:"column", height:"100%" }}>
      ...
      <div style={{ marginTop:"auto", paddingTop:16, display:"flex", justifyContent:"flex-end" }}>
        <div style={{ width:32, height:32, flexShrink:0, borderRadius:6, border:`2px solid ${isActive?C.orange:C.orange}`, display:"flex", alignItems:"center", justifyContent:"center", transition:"transform .3s,border-color .2s", transform:isActive?"rotate(45deg)":"none", color:isActive?C.orange:C.orange }}><svg width="13" height="13" viewBox="0 0 13 13" fill="none"><path d="M6.5 1v11M1 6.5h11" stroke="currentColor" strokeWidth="2.2" strokeLinecap="round"/></svg></div>
      </div>
    </div>
  </div>
);
...
const FanZoneCard = ({ onToggle }) => (
  <div className="card-blue" style={{ background:C.surface, borderRadius:12, cursor:"pointer", marginTop:24, padding:"20px 22px", display:"flex", flexDirection:"column" }} onClick={onToggle}>
    ...
    <div style={{ marginTop:"auto", display:"flex", justifyContent:"flex-end" }}>
        <div style={{ width:32, height:32, flexShrink:0, borderRadius:6, border:`1px solid ${C.dim}`, display:"flex", alignItems:"center", justifyContent:"center", color:C.dim }}><svg width="13" height="13" viewBox="0 0 13 13" fill="none"><path d="M6.5 1v11M1 6.5h11" stroke="currentColor" strokeWidth="2.2" strokeLinecap="round"/></svg></div>
    </div>
  </div>
);
...
const SPosition = () => {
  ...
  <Sec id="position" num="03" label="Your Position" accent={C.blue}>
    ...
    <div className="callout-left-orange" style={{ marginTop:10, cursor:"pointer", display:"flex", flexDirection:"column" }} onClick={() => { setSfStaffOpen(o => !o); setFzOpen(false); setActive(null); }}>
      ...
      <div style={{ marginTop:"auto", display:"flex", justifyContent:"flex-end" }}>
        <div style={{ width:32, height:32, flexShrink:0, borderRadius:6, border:`2px solid ${sfStaffOpen?C.orange:C.orange}`, display:"flex", alignItems:"center", justifyContent:"center", transition:"transform .3s,border-color .2s", transform:sfStaffOpen?"rotate(45deg)":"none", color:sfStaffOpen?C.orange:C.orange }}><svg width="13" height="13" viewBox="0 0 13 13" fill="none"><path d="M6.5 1v11M1 6.5h11" stroke="currentColor" strokeWidth="2.2" strokeLinecap="round"/></svg></div>
      </div>
    </div>
...
const PillarCard = ({ pillar, isActive, onToggle }) => (
  <div className={`pillar-card ${pillar.color==='#FF6700'?"card-orange":"card-blue"} ${isActive?"active":""}`} onClick={onToggle}>
    <div style={{ padding:"22px 20px 20px 20px", display:"flex", flexDirection:"column", height:"100%" }}>
      ...
      <div style={{ marginTop:"auto", paddingTop:16, display:"flex", justifyContent:"flex-end" }}>
        <div style={{ width:32, height:32, flexShrink:0, borderRadius:6, border:`2px solid ${isActive?pillar.color:pillar.color}`, display:"flex", alignItems:"center", justifyContent:"center", transition:"transform .3s,border-color .2s", transform:isActive?"rotate(45deg)":"none", color:isActive?pillar.color:pillar.color }}><svg width="13" height="13" viewBox="0 0 13 13" fill="none"><path d="M6.5 1v11M1 6.5h11" stroke="currentColor" strokeWidth="2.2" strokeLinecap="round"/></svg></div>
      </div>
    </div>
  </div>
);
  ...
  return (
    <Sec id="ai" num="05" label="HI ∞ AI ∞ HI Prompts" accent={C.blue}>
      <h2 className="d" style={{ fontSize:"clamp(28px,4.2vw,48px)", fontWeight:800, lineHeight:1.04, letterSpacing:"-.02em", marginBottom:14, color:C.text }}>
        ...
        <span style={{ color:C.text }}>Free your </span><span style={{ color:C.blue }}>Instinct</span><span style={{ color:C.text }}>.</span>
      </h2>
      <p style={{ fontSize:19, color:C.muted, fontWeight:300, lineHeight:1.78, marginBottom:24, maxWidth:"90%" }}>
        12 years of tournament tourism data, complex regional planning, supply chain variables across 16 host markets. There's a substantial library here. This 3-prompt sequence brings that research plus locally relevant intelligence into your AI platform - confirmed fan zones, team base camps, corridor projections, liquor law variances, scheduling ordinances - filtered through a framework that tells you which parts are confirmed and which parts you still need to verify.
      </p>

      {/* ── BRIEF YOUR AI ── card-blue */}
      <button onClick={() => { setBriefOpen(o => !o); }} style={{ width:"100%", background:"none", border:"none", cursor:"pointer", padding:0, display:"block", textAlign:"left" }}>
        <div className="card-blue" style={{ background:C.surface, borderRadius:12, padding:"20px 22px", display:"flex", flexDirection:"column" }}>
          <div style={{ fontSize:20, fontWeight:700, letterSpacing:".08em", textTransform:"uppercase", color:C.text, marginBottom:8 }}>Three-Shot Prompt: Brief Your AI Platform(s)</div>
          ...
          <div style={{ marginTop:"auto", display:"flex", justifyContent:"flex-end" }}>
            <div style={{ width:32, height:32, flexShrink:0, borderRadius:6, border:`2px solid ${C.blue}`, display:"flex", alignItems:"center", justifyContent:"center", transition:"transform .3s", transform:briefOpen?"rotate(45deg)":"none", color:C.blue }}><svg width="13" height="13" viewBox="0 0 13 13" fill="none"><path d="M6.5 1v11M1 6.5h11" stroke="currentColor" strokeWidth="2.2" strokeLinecap="round"/></svg></div>
          </div>
        </div>
      </button>
      <div className={`xbody ${briefOpen?"open":""}`}>
        <div style={{ padding:"24px 4px 8px", display:"flex", flexDirection:"column", gap:20 }}>

          {/* Opening frame */}
          <div style={{ borderLeft:`3px solid ${C.blue}`, paddingLeft:18 }}>
            <p style={{ fontSize:18, color:C.blue, fontWeight:800, textTransform:"uppercase", lineHeight:1.82, marginBottom:12 }}>This is intended for operators who use AI (in the platforms who "know" them)</p>
            <p style={{ fontSize:18, color:C.muted, lineHeight:1.82, marginBottom:12 }}>Your AI platform already "knows" you. Incomplete context, but helpful. These prompts bring the other half: the tournament research mapped to your specific restaurant and your specific market. When those two things meet inside a platform that already has your context, the conversation that follows is a different quality than anything you could start from scratch. It also sets your platform up for a more disciplined conversation than it would find on its own.</p>
            <p style={{ fontSize:18, color:C.text, fontWeight:800, textTransform:"uppercase", lineHeight:1.82, marginBottom:8 }}>Seven questions build that context. Fill them in once. They ride into all three prompts. Here is what the sequence does:</p>
            <div style={{ display:"flex", flexDirection:"column", gap:10, marginBottom:12, paddingLeft:4 }}>
              <div style={{ display:"flex", gap:12, alignItems:"flex-start" }}>
                <svg width="8" height="8" viewBox="0 0 8 8" fill="none" style={{ flexShrink:0, marginTop:7 }}><polygon points="0,0 8,4 0,8" fill={C.blue}/></svg>
                <p style={{ fontSize:18, color:C.muted, lineHeight:1.75, margin:0 }}>The first is a deep research prompt. Its intention is to take your inputs into a platform capable of real-time research and produce a profile of your specific operation mapped against the tournament research. Where you sit in the surge geography. What pressure points apply to you. What decisions you haven't made yet. You get a document you hold. That document is the foundation everything else builds on.</p>
              </div>
              <div style={{ display:"flex", gap:10, alignItems:"flex-start", paddingLeft:20 }}>
                <span style={{ fontSize:12, fontWeight:700, letterSpacing:".1em", textTransform:"uppercase" }}>
                  <span style={{ color:C.orange }}>[HI ∞ AI ∞ HI]</span><span style={{ color:C.dim }}> Your instinct is the only thing that can validate what the AI found. Nothing moves forward until it passes through you.</span>
                </span>
              </div>
              <div style={{ display:"flex", gap:12, alignItems:"flex-start" }}>
                <svg width="8" height="8" viewBox="0 0 8 8" fill="none" style={{ flexShrink:0, marginTop:7 }}><polygon points="0,0 8,4 0,8" fill={C.blue}/></svg>
                <p style={{ fontSize:18, color:C.muted, lineHeight:1.75, margin:0 }}>This prompt is also deep research, but it brings something different: the local intelligence your profile alone can't surface. Fan zones near you, team base camps within range, corridor conditions, liquor license requirements, scheduling ordinances. What's actually happening in your market this summer. Everything jurisdiction-specific comes back labeled directional only, because the AI is searching, not confirming. The value is that it tells you what to verify, not what to assume.</p>
              </div>
              <div style={{ display:"flex", gap:10, alignItems:"flex-start", paddingLeft:20 }}>
                <span style={{ fontSize:12, fontWeight:700, letterSpacing:".1em", textTransform:"uppercase" }}>
                  <span style={{ color:C.orange }}>[HI ∞ AI ∞ HI]</span><span style={{ color:C.dim }}> Local intelligence is directional until you verify it. A wrong assumption carried into the last prompt becomes a wrong plan. This is where you own that.</span>
                </span>
              </div>
              <div style={{ display:"flex", gap:12, alignItems:"flex-start" }}>
                <svg width="8" height="8" viewBox="0 0 8 8" fill="none" style={{ flexShrink:0, marginTop:7 }}><polygon points="0,0 8,4 0,8" fill={C.blue}/></svg>
                <p style={{ fontSize:18, color:C.muted, lineHeight:1.75, margin:0 }}>The last prompt opens a planning conversation with both research outputs already loaded into your platform. Your AI isn't starting cold. You aren't explaining yourself from scratch. What makes this useful is what the first two built: a platform that "knows" you is now also holding a complete picture of your operation, your market, and what's coming. Together, they make the conversation that follows more specific, more grounded, and harder to get wrong.</p>
              </div>
            </div>
            <p style={{ fontSize:18, color:C.text, fontWeight:700, lineHeight:1.82, margin:0 }}>Your instinct is the checkpoint between each prompt. Your AI doesn't lead this. You do.</p>
          </div>
          ...
          <div style={{ display:"flex", flexDirection:"column", gap:16 }}>
            <div>
              ...
              <input type="text" value={form.address} onChange={e=>setField("address",e.target.value)} placeholder="123 Main St, City, State" style={{ width:"100%", background:C.surf2, border:`1px solid ${C.border}`, borderRadius:8, padding:"11px 14px", fontSize:16, color:C.text, fontFamily:"'Jost',sans-serif", outline:"none", boxSizing:"border-box" }}/>
            </div>
            <div>
              ...
              <input type="text" value={form.website} onChange={e=>setField("website",e.target.value)} placeholder="www.yourrestaurant.com" style={{ width:"100%", background:C.surf2, border:`1px solid ${C.border}`, borderRadius:8, padding:"11px 14px", fontSize:16, color:C.text, fontFamily:"'Jost',sans-serif", outline:"none", boxSizing:"border-box" }}/>
            </div>
            {[
              ...
              <div key={q.key}>
                ...
                <div style={{ display:"flex", flexWrap:"wrap", gap:8 }}>
                  {q.opts.map(o => (
                    <button key={o} onClick={()=>setField(q.key,o)} style={{ background: form[q.key]===o ? C.blue : C.surf2, border:`1px solid ${form[q.key]===o?C.blue:C.border}`, borderRadius:20, padding:"7px 16px", cursor:"pointer", fontSize:14, fontWeight:700, letterSpacing:".06em", color: form[q.key]===o ? "#fff" : C.muted, fontFamily:"'Jost',sans-serif", transition:"all .15s" }}>{o}</button>
                  ))}
                </div>
              </div>
            ))}
            <div>
              ...
              <div style={{ display:"flex", flexWrap:"wrap", gap:8 }}>
                {["POS system","Contactless payments","Online ordering (direct)","Third-party delivery","Loyalty program","Reservation / waitlist system","Digital menu"].map(o => (
                  <button key={o} onClick={()=>toggleTech(o)} style={{ background: form.tech.includes(o) ? C.blue : C.surf2, border:`1px solid ${form.tech.includes(o)?C.blue:C.border}`, borderRadius:20, padding:"7px 16px", cursor:"pointer", fontSize:14, fontWeight:700, letterSpacing:".06em", color: form.tech.includes(o) ? "#fff" : C.muted, fontFamily:"'Jost',sans-serif", transition:"all .15s" }}>{o}</button>
                ))}
              </div>
            </div>
          </div>

          {!formReady && <p style={{ fontSize:14, color:C.dim, fontStyle:"italic" }}>Add your address and website to unlock the prompts.</p>}
          ...
          <div className="callout-left-blue" style={{ opacity: formReady?1:.45, transition:"opacity .2s" }}>
            ...
            <p style={{ fontSize:18, color:C.muted, lineHeight:1.78, marginBottom:14 }}>Your AI reads the Infinite Restaurants research and your specific operation in the same pass. It locates you in the surge geography, identifies your pressure points, and surfaces what you haven't decided yet. Output is a profile document you hold.</p>
            <button disabled={!formReady} onClick={()=>setActivePrompt(activePrompt===1?null:1)} style={{ background:formReady?C.blue:"transparent", border:`1px solid ${formReady?C.blue:C.border}`, borderRadius:20, padding:"7px 18px", cursor:formReady?"pointer":"not-allowed", fontSize:13, fontWeight:700, letterSpacing:".08em", textTransform:"uppercase", color:formReady?"#fff":C.dim, fontFamily:"'Jost',sans-serif" }}>
              {activePrompt===1 ? "Close" : "Get Prompt 1"}
            </button>
            {activePrompt===1 && <textarea readOnly value={prompts[1]} style={{ marginTop:14, width:"100%", background:C.bg, border:`1px solid ${C.border}`, borderRadius:8, padding:"14px", fontSize:13, color:C.muted, fontFamily:"'Jost',sans-serif", lineHeight:1.7, minHeight:220, resize:"vertical", boxSizing:"border-box" }}/>}
          </div>

          {/* HI gate 1 */}
          <div style={{ background:C.bg, border:`1px solid ${C.border}`, borderLeft:`4px solid ${C.orange}`, borderRadius:"0 8px 8px 0", padding:"16px 20px" }}>
            <div style={{ fontSize:12, fontWeight:700, letterSpacing:".12em", textTransform:"uppercase", marginBottom:8 }}>
              <span style={{ color:C.orange }}>[HI ∞ AI ∞ HI]</span><span style={{ color:C.text }}>: Human in the Loop, Human in the Lead</span>
            </div>
            <p style={{ fontSize:16, color:C.muted, lineHeight:1.75, margin:0 }}>Read the output before you do anything else. This is not a pause. It is the work. Your instinct confirms the profile. If something is wrong, correct it here. What you carry into Prompt 2 is what Prompt 2 builds on.</p>
          </div>
          ...
          <div className="callout-left-blue" style={{ opacity: formReady?1:.45, transition:"opacity .2s" }}>
            ...
            <p style={{ fontSize:18, color:C.muted, lineHeight:1.78, marginBottom:14 }}>Takes your confirmed profile and researches the local specifics: fan zones, base camps, corridor conditions, liquor license requirements, scheduling ordinances. Everything jurisdiction-specific comes back labeled directional only. The AI is searching, not confirming.</p>
            <button disabled={!formReady} onClick={()=>setActivePrompt(activePrompt===2?null:2)} style={{ background:formReady?C.blue:"transparent", border:`1px solid ${formReady?C.blue:C.border}`, borderRadius:20, padding:"7px 18px", cursor:formReady?"pointer":"not-allowed", fontSize:13, fontWeight:700, letterSpacing:".08em", textTransform:"uppercase", color:formReady?"#fff":C.dim, fontFamily:"'Jost',sans-serif" }}>
              {activePrompt===2 ? "Close" : "Get Prompt 2"}
            </button>
            {activePrompt===2 && <textarea readOnly value={prompts[2]} style={{ marginTop:14, width:"100%", background:C.bg, border:`1px solid ${C.border}`, borderRadius:8, padding:"14px", fontSize:13, color:C.muted, fontFamily:"'Jost',sans-serif", lineHeight:1.7, minHeight:180, resize:"vertical", boxSizing:"border-box" }}/>}
          </div>
          ...
          <div style={{ background:C.bg, border:`1px solid ${C.border}`, borderLeft:`4px solid ${C.orange}`, borderRadius:"0 8px 8px 0", padding:"16px 20px" }}>
            ...
            <p style={{ fontSize:16, color:C.muted, lineHeight:1.75, margin:0 }}>Review the local intelligence. Flag anything that needs verification before it becomes a planning assumption. That judgment is yours. The AI cannot make it for you.</p>
          </div>
          ...
          <div className="callout-left-blue" style={{ opacity: formReady?1:.45, transition:"opacity .2s" }}>
            ...
            <p style={{ fontSize:18, color:C.muted, lineHeight:1.78, marginBottom:14 }}>Your AI opens already loaded with both research outputs. You aren't explaining your situation. You aren't setting context. You direct toward the decision that matters most right now.</p>
            <button disabled={!formReady} onClick={()=>setActivePrompt(activePrompt===3?null:3)} style={{ background:formReady?C.blue:"transparent", border:`1px solid ${formReady?C.blue:C.border}`, borderRadius:20, padding:"7px 18px", cursor:formReady?"pointer":"not-allowed", fontSize:13, fontWeight:700, letterSpacing:".08em", textTransform:"uppercase", color:formReady?"#fff":C.dim, fontFamily:"'Jost',sans-serif" }}>
              {activePrompt===3 ? "Close" : "Get Prompt 3"}
            </button>
            {activePrompt===3 && <textarea readOnly value={prompts[3]} style={{ marginTop:14, width:"100%", background:C.bg, border:`1px solid ${C.border}`, borderRadius:8, padding:"14px", fontSize:13, color:C.muted, fontFamily:"'Jost',sans-serif", lineHeight:1.7, minHeight:200, resize:"vertical", boxSizing:"border-box" }}/>}
          </div>
      ...
      <div style={{ marginTop:16 }}>
        <button onClick={() => setShotsOpen(o => !o)} style={{ width:"100%", background:"none", border:"none", cursor:"pointer", padding:0, display:"block", textAlign:"left" }}>
          <div className="card-blue" style={{ background:C.surface, borderRadius:12, padding:"20px 22px", display:"flex", flexDirection:"column" }}>
            <div style={{ fontSize:20, fontWeight:700, letterSpacing:".08em", textTransform:"uppercase", color:C.text, marginBottom:8 }}>One-Shot Prompts: Focused AI Chat Starters</div>
            ...
            <div style={{ marginTop:"auto", display:"flex", justifyContent:"flex-end" }}>
              <div style={{ width:32, height:32, flexShrink:0, borderRadius:6, border:`2px solid ${shotsOpen?C.blue:C.blue}`, display:"flex", alignItems:"center", justifyContent:"center", transition:"transform .3s,border-color .2s", transform:shotsOpen?"rotate(45deg)":"none", color:shotsOpen?C.blue:C.blue }}><svg width="13" height="13" viewBox="0 0 13 13" fill="none"><path d="M6.5 1v11M1 6.5h11" stroke="currentColor" strokeWidth="2.2" strokeLinecap="round"/></svg></div>
            </div>
          </div>
        </button>
      ...
      {/* ── TAKE THIS FURTHER ── orange-accented expandable */}
      <div style={{ marginTop:16 }}>
        <div className="card-orange" style={{ background:C.surface, borderRadius:12, cursor:"pointer", padding:"20px 22px", display:"flex", flexDirection:"column" }} onClick={() => setFurtherOpen(o => !o)}>
          ...
          <div style={{ marginTop:"auto", display:"flex", justifyContent:"flex-end" }}>
            <div style={{ width:32, height:32, flexShrink:0, borderRadius:6, border:`2px solid ${C.orange}`, display:"flex", alignItems:"center", justifyContent:"center", transition:"transform .3s", transform:furtherOpen?"rotate(45deg)":"none", color:C.orange }}><svg width="13" height="13" viewBox="0 0 13 13" fill="none"><path d="M6.5 1v11M1 6.5h11" stroke="currentColor" strokeWidth="2.2" strokeLinecap="round"/></svg></div>
          </div>
        </div>
        <div className={`xbody ${furtherOpen?"open":""}`}>
          <div style={{ paddingTop:18, paddingBottom:8, display:"flex", flexDirection:"column", gap:14 }}>
            ...
            {[
              ...
              { label:"CustomGPT", color:C.blue, note:"ChatGPT users: save the three outputs as a CustomGPT knowledge file. Every conversation opens with your tournament context pre-loaded. Once it's configured, you stop explaining your situation from scratch." },
      ...
      {/* ── HI ∞ AI ∞ HI ── callout-left-orange expandable, SFCard pattern */}
      <div style={{ marginTop:16 }}>
        <div className="callout-left-blue" style={{ background:C.surface, borderRadius:"0 12px 12px 0", cursor:"pointer", display:"flex", flexDirection:"column" }} onClick={() => setHiOpen(o => !o)}>
          ...
          <div style={{ marginTop:"auto", display:"flex", justifyContent:"flex-end" }}>
            <div style={{ width:32, height:32, flexShrink:0, borderRadius:6, border:`2px solid ${C.blue}`, display:"flex", alignItems:"center", justifyContent:"center", transition:"transform .3s", transform:hiOpen?"rotate(45deg)":"none", color:C.blue }}><svg width="13" height="13" viewBox="0 0 13 13" fill="none"><path d="M6.5 1v11M1 6.5h11" stroke="currentColor" strokeWidth="2.2" strokeLinecap="round"/></svg></div>
          </div>
        </div>
        <div className={`xbody ${hiOpen?"open":""}`}>
          <div style={{ paddingTop:24, paddingBottom:8, display:"flex", flexDirection:"column", gap:22 }}>
            <div className="d" style={{ fontSize:"clamp(16px,2vw,22px)", fontWeight:800, letterSpacing:".04em", textTransform:"uppercase", color:C.text, lineHeight:1.15 }}>
              HI ∞ AI ∞ HI: Human Intellect › AI › Hospitality Instinct
            </div>
            <p style={{ fontSize:18, color:C.text, lineHeight:1.82 }}>
              Instinct is what runs a restaurant. You built it the hard way - reading tables before they speak, sensing when a shift is about to break, knowing your supply chain in your gut before the invoice confirms it. The problem isn't that operators lack instinct. It's that the inputs demanding your attention never stop, and instinct runs quiet while everything else runs loud. Dashboards, alerts, trend reports, industry noise - they crowd the room until the signal you actually need gets buried. AI can deepen that pile or it can cut through it. The operators who use it well are the ones who bring their instinct to both ends: what they ask and what they do with the answer.
            </p>
            <p style={{ fontSize:18, color:C.muted, lineHeight:1.82 }}>
              AI excels at pattern recognition. It doesn't think. It doesn't decide. It doesn't know your dining room, your regulars, your rep, or your neighborhood. Simply put: It doesn't have the feelings, instincts, or gut level recognition of "what's right"... the details that separate a logical conclusion from the right CHOICE.
            </p>
            <p style={{ fontSize:18, color:C.muted, lineHeight:1.82 }}>
              What it can do is expand what you're able to see and act on, fast. That's the amplification layer. You open the conversation. You close it. The output is only as good as the judgment you bring to both ends.
            </p>
            <div className="callout-left-blue">
                ...
                {aiPlatforms.map((p,i) => (
                  <div key={i} style={{ borderBottom: i<aiPlatforms.length-1?`1px solid ${C.border}`:"none" }}>
                    <button onClick={() => setActivePlatform(activePlatform===i?null:i)} style={{ width:"100%", background:"none", border:"none", cursor:"pointer", padding:"14px 18px", display:"flex", alignItems:"center", justifyContent:"space-between", textAlign:"left" }}>
                      ...
                      <div style={{ width:28, height:28, flexShrink:0, borderRadius:5, border:`1px solid ${activePlatform===i?C.blue:C.blue}`, display:"flex", alignItems:"center", justifyContent:"center", transition:"transform .3s,border-color .2s", transform:activePlatform===i?"rotate(45deg)":"none", color:activePlatform===i?C.blue:C.blue }}><svg width="11" height="11" viewBox="0 0 13 13" fill="none"><path d="M6.5 1v11M1 6.5h11" stroke="currentColor" strokeWidth="2.0" strokeLinecap="round"/></svg></div>
                    </button>
  ...
  return (
    <div style={{ borderBottom:`1px solid ${C.border}` }}>
      <button onClick={onToggle} style={{ width:"100%", background:"none", border:"none", cursor:"pointer", padding:"16px 20px", display:"flex", alignItems:"flex-start", justifyContent:"space-between", textAlign:"left", gap:16 }}>
        ...
        <div style={{ width:28, height:28, flexShrink:0, borderRadius:5, border:`1px solid ${isOpen?C.blue:C.blue}`, display:"flex", alignItems:"center", justifyContent:"center", transition:"transform .3s,border-color .2s", transform:isOpen?"rotate(45deg)":"none", color:isOpen?C.blue:C.blue }}><svg width="11" height="11" viewBox="0 0 13 13" fill="none"><path d="M6.5 1v11M1 6.5h11" stroke="currentColor" strokeWidth="2.0" strokeLinecap="round"/></svg></div>
      </button>
...
<div style={{ width:32, height:32, flexShrink:0, borderRadius:6, border:`2px solid ${open?accent:accent}`, display:"flex", alignItems:"center", justifyContent:"center", transition:"transform .3s,border-color .2s", transform:open?"rotate(45deg)":"none", color:open?accent:accent }}><svg width="13" height="13" viewBox="0 0 13 13" fill="none"><path d="M6.5 1v11M1 6.5h11" stroke="currentColor" strokeWidth="2.2" strokeLinecap="round"/></svg></div>
    </button>
  );
                ...
                <div key={i} style={{ borderBottom: i<methodologies.length-1?`1px solid ${C.border}`:"none" }}>
                  <details>
                    <summary style={{ padding:"16px 20px", fontSize:14, fontWeight:700, color:C.text, cursor:"pointer", listStyle:"none", display:"flex", justifyContent:"space-between", alignItems:"center", background:C.surface }}>
                      {m.title}
                      <div style={{ width:24, height:24, flexShrink:0, borderRadius:5, border:`1px solid ${C.dim}`, display:"flex", alignItems:"center", justifyContent:"center", color:C.dim, marginLeft:12 }}><svg width="11" height="11" viewBox="0 0 13 13" fill="none"><path d="M6.5 1v11M1 6.5h11" stroke="currentColor" strokeWidth="2.0" strokeLinecap="round"/></svg></div>
                    </summary>
            ...
            <div>
              <button onClick={() => setSrcOpen(o => !o)} style={{ width:"100%", background:"none", border:"none", cursor:"pointer", textAlign:"left", display:"flex", alignItems:"center", justifyContent:"space-between", marginBottom: srcOpen ? 16 : 0, padding:0 }}>
                ...
                <div style={{ display:"flex", alignItems:"center", gap:8, fontSize:14, fontWeight:700, letterSpacing:".1em", textTransform:"uppercase", color:C.dim }}>
                  ...
                  <div style={{ width:28, height:28, flexShrink:0, borderRadius:5, border:`1px solid ${srcOpen?C.blue:C.blue}`, display:"flex", alignItems:"center", justifyContent:"center", transition:"transform .3s,border-color .2s", transform:srcOpen?"rotate(45deg)":"none", color:srcOpen?C.blue:C.blue }}><svg width="11" height="11" viewBox="0 0 13 13" fill="none"><path d="M6.5 1v11M1 6.5h11" stroke="currentColor" strokeWidth="2.0" strokeLinecap="round"/></svg></div>
                </div>
              </button>
