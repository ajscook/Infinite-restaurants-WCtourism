    ...
    <nav style={{ position: "sticky", top: 0, zIndex: 200, background: "rgba(13,15,20,.96)", backdropFilter: "blur(16px)", borderBottom: `1px solid ${C.border}` }}>
      <div style={{ ...W, display: "flex", alignItems: "center", justifyContent: "space-between", gap: 12, padding: "26px 120px", position: "relative" }}>
        ...
        <div className="nav-tabs-desktop">
          {[["who",<>Super<br/>Tourist</>],["where",<>Travel<br/>Patterns</>],["position",<>Your<br/>Position</>],["action",<>Prep<br/>Priorities</>],["ai",<>HI ∞ AI ∞ HI</>]].map(([id, label]) => (
  ...
  <section style={{ display: "flex", flexDirection: "column", justifyContent: "flex-start", padding: "clamp(40px,8vh,100px) 0 clamp(24px,4vh,48px)", position: "relative", overflow: "hidden" }}>
    ...
    <div style={{ ...W, position: "relative", zIndex: 1, padding: "48px 120px 18px" }}>
      ...
      <div className="u2" style={{ marginBottom: 48, maxWidth: "90%" }}>
        ...
        <p style={{ fontSize: "clamp(18px,2.4vw,22px)", fontWeight: 700, color: C.text, lineHeight: 1.6, marginBottom: 14, textTransform: "uppercase", letterSpacing: ".06em" }}>Three tournaments: same pattern</p>
        <p style={{ fontSize: "clamp(17px,2vw,20px)", fontWeight: 300, color: C.muted, lineHeight: 1.78 }}>
          The biggest F&amp;B spending increases happened in secondary markets; smaller cities and regional hubs. The Super Tourists are mobile. They base camp outside the host city, eat where the wait times are shorter, prefer local independents over chain brands, and they spend $140 to $180 per person per day doing it.
        </p>
      </div>
      ...
      <div className="multiplier-bar" style={{ display: "flex", alignItems: "center" }}>
        ...
        <div style={{ display: "flex", alignItems: "center", flex: 1, gap: 16, flexWrap: "wrap" }}>
          ...
          <div style={{ flex: 1, textAlign: "center", minWidth: 60 }}>
            <div className="n" style={{ fontSize: 38, fontWeight: 700, lineHeight: 1 }}>
              <span style={{ color: C.text, fontWeight: 400 }}>~</span><span style={{ color: C.blue }}>2</span><span style={{ color: C.text, fontWeight: 400 }}>x</span>
            </div>
            <div className="multiplier-label" style={{ fontSize: 14, fontWeight: 700, letterSpacing: ".1em", textTransform: "uppercase", color: C.text, marginTop: 5 }}>Daily F&B Spend</div>
          </div>
          ...
          <div style={{ flex: 1, textAlign: "center", minWidth: 60 }}>
            ...
            <div className="multiplier-label" style={{ fontSize: 14, fontWeight: 700, letterSpacing: ".1em", textTransform: "uppercase", color: C.text, marginTop: 5 }}>Stay Length</div>
          </div>
          ...
          <div style={{ flex: 1, textAlign: "center", minWidth: 60 }}>
            ...
            <div className="multiplier-label" style={{ fontSize: 14, fontWeight: 700, letterSpacing: ".1em", textTransform: "uppercase", color: C.text, marginTop: 5 }}>Revenue Potential</div>
          </div>
        ...
        <div style={{ paddingLeft: 24, flexShrink: 0, maxWidth: 220 }}>
          <p className="minivan-text" style={{ fontSize:18, fontWeight: 700, color: C.text, lineHeight: 1.5, textAlign:"center" }}>
...
const SWhere = () => {
  ...
  <Sec id="where" num="02" label="Travel Patterns" accent={C.orange}>
    ...
    <div className="callout-left-orange" style={{ display:"flex", flexDirection:"column" }}>
      <div className="callout-title" style={{ fontSize:19, fontWeight:700, letterSpacing:".12em", textTransform:"uppercase", color:C.text, marginBottom:10 }}>Not a prediction, a pattern</div>
...
const platformModels = [
  {
    ...
    color: "#10A37F",
    tag: "Easiest",
    desc: "A CustomGPT loaded with this platform's research and trained to continue the research focused on you and collaborate on your terms.",
    path: [
      "Fill your operation context below.",
      "Get your short input block from the 3-shot section inside.",
      "Click the Custom GPT link. Paste your input block. The tool is already loaded.",
      "Deep research runs inside the Custom GPT. No surface switch needed.",
    ],
  ...
  },
  {
    ...
    color: "#4285F4",
    tag: "Reliable",
    desc: "2-step start. A Deep Research, followed by a Gemini Gem. Google's AI sees your business differently. Using the Google Workspace already? Go this route.",
    path: [
      "Fill your operation context below.",
      "Get your Prompt 1 input from the 3-shot section. Run it in a standard Gemini session using deep research.",
      "Copy that output. Open the Gem. Paste the output and your Prompt 2 input.",
      "Prompt 3 runs in the Gem as a conversation. The Gem is already loaded with the research.",
    ],
    deepResearch: "Runs in a standard Gemini session. Bring the output to the Gem for Prompts 2 and 3.",
    seam: "One surface switch: deep research happens outside the Gem. You carry the output across.",
    cta: "Open Gem",
  ...
  },
  {
    ...
    color: "#7B61FF",
    tag: "Best",
    desc: "Claude is different. with a prompt It reads the platform helps you find your place in it, helps you think and follows you through.",
    path: [
      "Fill your operation context below.",
...
Restaurant name: ${form.name||form.address}
Address: ${form.address}
Website: ${form.website}
Google Business Profile: ${form.gbp||"Not provided"}
Current hours: ${form.hours_text||"Not confirmed"}
Price point: ${form.price_level||"Not confirmed"}
Cuisine types: ${form.cuisine_types||"Not confirmed"}
Google rating: ${form.rating ? `${form.rating}/5 (${form.review_count} reviews)` : "Not confirmed"}
...
Note: address, website, GBP, hours, price point, cuisine, and rating above are confirmed from Google Places. Treat as verified. Do not re-research these fields. Direct research energy toward surge geography, corridor position, fan zone proximity, and gap analysis relative to the confirmed rating and review count.
</operation>`;
...
The operation fields above are confirmed from Google Places - treat them as verified. Do not re-research name, address, hours, price point, or cuisine. Direct your research toward locating this operation in the surge geography: proximity to 2026 host cities, corridor position, fan zone proximity, excursion destination potential. Then map confirmed operational data against the tournament research patterns. Where does the gap between confirmed hours and tournament demand timing land? What does the rating and review count signal about digital visibility readiness?

Map what you find against the tournament research in your knowledge base. What is its risk profile? What is its opportunity profile? What has it already done that is working in its favor? What gaps stand out against what the research says matters?
...
When the profile is complete, stop. Do not recommend actions. Do not produce a plan. Present the profile and wait. The operator will tell you where to go next.`;
  ...
  const prompts = {
    ...
    3: isShort
      ? `[PASTE YOUR PROMPT 1 OUTPUT HERE]\n\n[PASTE YOUR PROMPT 2 OUTPUT HERE]\n\n---\nYou are a thinking partner. Read the context above. Surface what I might be missing. Challenge assumptions I am taking for granted. Ask questions that move my thinking forward. Do not produce a plan. My instinct is the decision layer. You are the amplification layer.\n\nThen wait. I will tell you where I want to start.`
  ...
  const questionPrompt = formReady && operatorQuestion.trim()
    ? isShort
      ? `${shortInput}\n\n---\nQuestion: ${operatorQuestion}\n\nYou are a thinking partner. Surface what I might be missing. Challenge assumptions. Ask questions that move my thinking forward. Do not produce a plan. My instinct is the decision layer.`
  ...
  const GenButtonInline = ({ generatorId, label }) => {
    ...
    return (
      <>
        <button onClick={() => setOpen(true)} style={{ background:"transparent", border:`1px solid ${C.border}`, borderRadius:20, padding:"7px 16px", cursor:"pointer", fontSize:14, fontWeight:700, letterSpacing:".06em", color:C.muted, fontFamily:"'Plus Jakarta Sans',sans-serif", transition:"border-color .15s, color .15s" }}
      ...
      <div onClick={e => e.stopPropagation()} style={{ background:C.surface, border:`2px solid ${C.blue}`, borderRadius:16, width:"100%", maxWidth:760, marginTop:8, marginBottom:24, boxShadow:"0 32px 80px rgba(0,0,0,.7)", display:"flex", flexDirection:"column" }}>
        ...
        {(model.id === "chatgpt" || model.id === "gemini") ? (
          <div style={{ padding:"24px", overflowY:"auto", maxHeight:"60vh", display:"flex", flexDirection:"column", gap:20 }}>
            ...
            {/* Prompt 1: Deep Research Handoff */}
            <div>
              <div style={{ fontSize:12, fontWeight:700, letterSpacing:".14em", textTransform:"uppercase", color:C.blue, marginBottom:4 }}>Prompt 1 - Deep Research</div>
              <p style={{ fontSize:14, color:C.muted, lineHeight:1.7, marginBottom:10 }}>
                {model.id === "chatgpt"
                  ? "Paste this into the Custom GPT. It researches your operation from your address, website, and GBP, locates you in the surge geography, maps you against the tournament patterns, and returns a profile. Read it. Then use Prompt 2."
                  : "Run this in a standard Gemini deep research session, not in the Gem. It researches your operation, locates you in the surge geography, and maps you against the tournament patterns. Read what comes back. Then take it to the Gem for Prompt 2."}
              </p>
            ...
            <div style={{ padding:"18px 20px", borderRadius:10, border:`1px solid ${C.border}`, borderLeft:`3px solid ${C.orange}` }}>
              <div style={{ fontSize:12, fontWeight:700, letterSpacing:".14em", textTransform:"uppercase", color:C.orange, marginBottom:8 }}>Before Prompt 2</div>
              <p style={{ fontSize:14, color:C.muted, lineHeight:1.75, marginBottom: model.id==="gemini" ? 12 : 0 }}>
                Read what it returned. Your instinct is the only thing that can validate it. If something feels off or seems wrong about how it placed you, correct it before you go further. What you confirm is what the assessment builds on.
                {model.id === "gemini" && " Copy the output and open the Gem before continuing."}
              </p>
              {model.id === "gemini" && (
                <a href="https://gemini.google.com/gem/YOUR-GEM-LINK" target="_blank" rel="noopener noreferrer" style={{ display:"inline-flex", alignItems:"center", gap:8, background:C.blue, border:"none", borderRadius:20, padding:"7px 18px", fontSize:12, fontWeight:700, letterSpacing:".08em", textTransform:"uppercase", color:"#fff", textDecoration:"none" }}>
            ...
            {/* Prompt 2: Assessment */}
            <div>
              <div style={{ fontSize:12, fontWeight:700, letterSpacing:".14em", textTransform:"uppercase", color:C.blue, marginBottom:4 }}>Prompt 2 - Assessment</div>
              <p style={{ fontSize:14, color:C.muted, lineHeight:1.7, marginBottom:10 }}>
                Paste this after the profile is returned and you've read it. The Custom GPT assesses your gaps, priorities, and risk profile against the patterns. Then it stops. You direct the conversation from there.
              </p>
              {formReady && (
            ...
            <div style={{ borderTop:`1px solid ${C.border}`, paddingTop:20 }}>
              <div style={{ fontSize:12, fontWeight:700, letterSpacing:".14em", textTransform:"uppercase", color:C.blue, marginBottom:14 }}>Go Deeper - Focused Prompts</div>
              {pillarGroups.map(pg => (
                <Expand key={pg.id} accent={pg.color} headline={pg.label} sub={pg.sub}>
                  <div style={{ display:"flex", flexWrap:"wrap", gap:8 }}>
                    {pg.generators.map(g => (
                      <button key={g.id} onClick={() => {}} style={{ background:"transparent", border:`1px solid ${C.border}`, borderRadius:20, padding:"5px 14px", cursor:"pointer", fontSize:13, letterSpacing:".04em", color:C.muted, fontFamily:"'Plus Jakarta Sans',sans-serif", transition:"border-color .15s, color .15s" }}
                        onMouseEnter={e => { e.currentTarget.style.borderColor=C.blue; e.currentTarget.style.color=C.text; }}
                        onMouseLeave={e => { e.currentTarget.style.borderColor=C.border; e.currentTarget.style.color=C.muted; }}>
                        {g.label}
                      </button>
            ...
            <div style={{ borderTop:`1px solid ${C.border}`, paddingTop:20, paddingBottom:8 }}>
              <div style={{ fontSize:12, fontWeight:700, letterSpacing:".14em", textTransform:"uppercase", color:C.blue, marginBottom:6 }}>Freestyle Prompt</div>
...
// ─── PLACES API KEY ──────────────────────────────────────────────────────────
const PLACES_API_KEY = "AIzaSyBL62AXpkX1CeycV4UoF-Ni8oDI4JMgkF4";

// ─── PLACES LIBRARY LOADER (new importLibrary API) ───────────────────────────
const usePlacesScript = () => {
  const [ready, setReady] = useState(false);
  useEffect(() => {
    const load = async () => {
      // If already bootstrapped, import the places library directly
      if (window.google?.maps?.importLibrary) {
        await window.google.maps.importLibrary("places");
        setReady(true);
        return;
      }
      // Bootstrap script not yet loaded
      ...
      // Inject bootstrap script using the new loading API
      window.__googlemaps_cb = async () => {
        await window.google.maps.importLibrary("places");
        setReady(true);
      };
      const s = document.createElement("script");
      s.id = "gmp-script";
      s.src = `https://maps.googleapis.com/maps/api/js?key=${PLACES_API_KEY}&callback=__googlemaps_cb&loading=async&v=weekly`;
      s.async = true;
...
// ─── FORMAT HOURS FROM PLACES API (new Place class format) ───────────────────
const formatPlacesHours = (regularOpeningHours) => {
  ...
  const byDay = {};
  regularOpeningHours.periods.forEach(p => {
    const d = p.open?.day;
    if (d == null) return;
    const open = fmt(p.open?.hour, p.open?.minute);
    const close = fmt(p.close?.hour, p.close?.minute);
    if (open) byDay[d] = close ? `${open} - ${close}` : `${open} - late`;
  });
  return Object.entries(byDay)
    .sort(([a],[b]) => Number(a) - Number(b))
    .map(([d, hrs]) => `${days[d]}: ${hrs}`)
    .join(", ");
};

// ─── PRICE LEVEL LABEL ────────────────────────────────────────────────────────
const priceLevelLabel = (v) => {
  const map = {
  ...
  // Handle enum string like "PRICE_LEVEL_MODERATE" or just "MODERATE"
  const key = String(v).replace(/^PRICE_LEVEL_/, "");
  return map[v] ?? map[key] ?? null;
};

// ─── PLACES SEARCH COMPONENT (new AutocompleteSuggestion API) ─────────────────
  ...
  const search = async (val) => {
    ...
    try {
      const { suggestions: results } = await AutocompleteSuggestion.fetchAutocompleteSuggestions({
        ...
        includedPrimaryTypes: ["restaurant","bar","food","cafe"],
      });
      setLoading(false);
  ...
  const handleSelect = async (suggestion) => {
    ...
    try {
      ...
      await place.fetchFields({
        fields: [
          "displayName","formattedAddress","websiteURI","googleMapsURI",
          "regularOpeningHours","priceLevel","types",
      ...
      const hours = formatPlacesHours(place.regularOpeningHours);
    ...
    <div style={{ position:"relative" }}>
      <div style={{ position:"relative" }}>
        <input
          ...
          style={{ width:"100%", background:C.surf2, border:`1px solid ${C.blue}`, borderRadius:8, padding:"12px 44px 12px 14px", fontSize:16, color:C.text, fontFamily:"'Plus Jakarta Sans',sans-serif", outline:"none", boxSizing:"border-box" }}
        />
        <div style={{ position:"absolute", right:14, top:"50%", transform:"translateY(-50%)", pointerEvents:"none" }}>
          {loading
            ? <svg width="16" height="16" viewBox="0 0 16 16" fill="none" style={{ animation:"spin .7s linear infinite" }}><circle cx="8" cy="8" r="6" stroke={C.dim} strokeWidth="2" strokeDasharray="28" strokeDashoffset="10"/></svg>
            : <svg width="16" height="16" viewBox="0 0 16 16" fill="none"><circle cx="6.5" cy="6.5" r="4.5" stroke={C.dim} strokeWidth="1.8"/><path d="M10 10l3 3" stroke={C.dim} strokeWidth="1.8" strokeLinecap="round"/></svg>
          }
        </div>
      </div>
      {focused && suggestions.length > 0 && (
        <div style={{ position:"absolute", top:"calc(100% + 4px)", left:0, right:0, background:C.surface, border:`1px solid ${C.blue}`, borderRadius:8, zIndex:400, overflow:"hidden", boxShadow:"0 8px 32px rgba(0,0,0,.4)" }}>
          {suggestions.map((s, i) => {
            const pred = s.placePrediction;
            const main = pred.mainText?.text || pred.text?.text || "";
            const secondary = pred.secondaryText?.text || "";
            return (
              <button key={pred.placeId} onMouseDown={() => handleSelect(s)}
                style={{ width:"100%", background:"none", border:"none", borderBottom: i < suggestions.length-1 ? `1px solid ${C.border}` : "none", padding:"12px 16px", cursor:"pointer", textAlign:"left", transition:"background .12s" }}
                onMouseEnter={e => e.currentTarget.style.background = `rgba(0,103,255,.08)`}
                onMouseLeave={e => e.currentTarget.style.background = "none"}>
                <div style={{ fontSize:14, fontWeight:700, color:C.text, marginBottom:2 }}>{main}</div>
                <div style={{ fontSize:12, color:C.dim }}>{secondary}</div>
              </button>
            );
          })}
        </div>
...
// ─── CONFIRMED DATA BADGE ─────────────────────────────────────────────────────
const ConfirmedBadge = () => (
  <span style={{ display:"inline-flex", alignItems:"center", gap:4, fontSize:11, fontWeight:700, letterSpacing:".1em", textTransform:"uppercase", color:C.orange, border:`1px solid ${C.orange}`, borderRadius:20, padding:"2px 8px" }}>
    <svg width="8" height="8" viewBox="0 0 8 8" fill="none"><path d="M1 4l2 2 4-4" stroke={C.orange} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/></svg>
    Confirmed
  </span>
);
...
const SAI = () => {
  ...
  const [placesConfirmed, setPlacesConfirmed] = useState(false);
  const placesReady = usePlacesScript();

  const [form, setForm] = useState({
    name:"", address:"", website:"", gbp:"", phone:"",
    hours_text:"", price_level:"", cuisine_types:"",
    rating:"", review_count:"",
    match_viewing:"", hours:"", staff:"", inventory:"", tech:[]
  });
  const setField = (k,v) => setForm(f => ({...f, [k]:v}));
  const toggleTech = (v) => setForm(f => ({ ...f, tech: f.tech.includes(v) ? f.tech.filter(x=>x!==v) : [...f.tech, v] }));

  const handlePlacesSelect = (data) => {
    setForm(f => ({ ...f, ...data }));
    setPlacesConfirmed(false);
  };

  const handleConfirm = () => setPlacesConfirmed(true);
  const handleEdit = () => setPlacesConfirmed(false);

  const formReady = form.address.trim() && form.website.trim() && placesConfirmed;

  const activeModel = platformModels.find(m => m.id === activePlatformModal);

  return (
    <Sec id="ai" num="05" label="HI ∞ AI ∞ HI" accent={C.blue}>
      <h2 className="d" style={{ fontSize:"clamp(32px,5.5vw,48px)", fontWeight:800, lineHeight:1.04, letterSpacing:"-.02em", marginBottom:14, color:C.text }}>
        <span style={{ color:C.text }}>Connect the </span><span style={{ color:C.orange }}>Intelligence</span><span style={{ color:C.text }}>.</span><br/>
        <span style={{ color:C.text }}>with Hospitality </span><span style={{ color:C.blue }}>Instinct</span><span style={{ color:C.text }}>.</span>
      </h2>
      <p style={{ fontSize:19, color:C.muted, fontWeight:300, lineHeight:1.78, marginBottom:24, maxWidth:"90%" }}>
        I wanted you AI users a clean way of accessing this research, rather than building a chatbot who doesn't 'know' you, the prompt generators below are a way to bring it all into an AI platform that does 'know' you - YOURS.
      </p>

      <p style={{ fontSize: "clamp(18px,2.4vw,22px)", fontWeight: 700, color: C.text, lineHeight: 1.6, marginBottom: 14, textTransform: "uppercase", letterSpacing: ".06em" }}><span style={{ color:C.blue }}>HUMAN</span> <span style={{ color:C.text }}>INTELLECT</span> <span style={{ color:C.text }}>{"\u2192"}</span> [<span style={{ color:C.orange }}>AI</span>] <span style={{ color:C.text }}>{"\u2192"}</span> <span style={{ color:C.blue }}>HOSPITALITY</span> <span style={{ color:C.text }}>INSTINCT</span></p>
      ...
      <div className="callout-left-orange" style={{ marginBottom:28 }}>
        <div className="callout-title" style={{ fontSize:19, fontWeight:700, letterSpacing:".12em", textTransform:"uppercase", color:C.text, marginBottom:10 }}>Human in the Loop. Human in the Lead.</div>
      ...
      <div className="card-blue" style={{ background:C.surface, borderRadius:12, padding:"24px 24px 20px", marginBottom:20 }}>
        ...
        <p style={{ fontSize:16, color:C.muted, lineHeight:1.7, marginBottom:20 }}>Find your restaurant to load your context automatically. Confirm what comes back before the prompts unlock.</p>

        {/* ── PLACES SEARCH ── */}
        {!placesConfirmed && (
          <div style={{ marginBottom:16 }}>
            <div style={{ fontSize:13, fontWeight:700, letterSpacing:".1em", textTransform:"uppercase", color:C.dim, marginBottom:6 }}>Find Your Restaurant</div>
            {placesReady
              ? <PlacesSearch onSelect={handlePlacesSelect} />
              : <div style={{ background:C.surf2, border:`1px solid ${C.border}`, borderRadius:8, padding:"12px 14px", fontSize:14, color:C.dim }}>Loading search...</div>
            }
          </div>
        )}

        {/* ── POPULATED PREVIEW / CONFIRMATION ── */}
        {form.address && !placesConfirmed && (
          <div style={{ border:`1px solid ${C.blue}`, borderRadius:10, overflow:"hidden", marginBottom:16 }}>
            <div style={{ background:`rgba(0,103,255,.08)`, padding:"14px 18px", borderBottom:`1px solid ${C.border}`, display:"flex", alignItems:"center", justifyContent:"space-between" }}>
              <div style={{ fontSize:13, fontWeight:700, letterSpacing:".12em", textTransform:"uppercase", color:C.blue }}>Review what we found</div>
              <div style={{ fontSize:12, color:C.dim }}>Edit any field before confirming</div>
            </div>
            <div style={{ padding:"18px 18px 14px", display:"flex", flexDirection:"column", gap:12 }}>
              ...
              <div style={{ display:"grid", gridTemplateColumns:"1fr 1fr", gap:12 }} className="two-col">
                <div>
                  <div style={{ fontSize:11, fontWeight:700, letterSpacing:".1em", textTransform:"uppercase", color:C.dim, marginBottom:4, display:"flex", alignItems:"center", gap:6 }}>Restaurant Name <ConfirmedBadge/></div>
                  <input type="text" value={form.name} onChange={e=>setField("name",e.target.value)} style={{ width:"100%", background:C.surf2, border:`1px solid ${C.border}`, borderRadius:6, padding:"9px 12px", fontSize:14, color:C.text, fontFamily:"'Plus Jakarta Sans',sans-serif", outline:"none", boxSizing:"border-box" }}/>
                </div>
                <div>
                  <div style={{ fontSize:11, fontWeight:700, letterSpacing:".1em", textTransform:"uppercase", color:C.dim, marginBottom:4, display:"flex", alignItems:"center", gap:6 }}>Address <ConfirmedBadge/></div>
                  <input type="text" value={form.address} onChange={e=>setField("address",e.target.value)} style={{ width:"100%", background:C.surf2, border:`1px solid ${C.border}`, borderRadius:6, padding:"9px 12px", fontSize:14, color:C.text, fontFamily:"'Plus Jakarta Sans',sans-serif", outline:"none", boxSizing:"border-box" }}/>
                </div>
              </div>
              ...
              <div style={{ display:"grid", gridTemplateColumns:"1fr 1fr", gap:12 }} className="two-col">
                <div>
                  <div style={{ fontSize:11, fontWeight:700, letterSpacing:".1em", textTransform:"uppercase", color:C.dim, marginBottom:4, display:"flex", alignItems:"center", gap:6 }}>
                    Website {form.website ? <ConfirmedBadge/> : <span style={{ fontSize:11, color:C.orange, fontWeight:700 }}>Not found - add manually</span>}
                  </div>
                  <input type="text" value={form.website} onChange={e=>setField("website",e.target.value)} placeholder="www.yourrestaurant.com" style={{ width:"100%", background:C.surf2, border:`1px solid ${form.website?C.border:C.orange}`, borderRadius:6, padding:"9px 12px", fontSize:14, color:C.text, fontFamily:"'Plus Jakarta Sans',sans-serif", outline:"none", boxSizing:"border-box" }}/>
                </div>
                <div>
                  <div style={{ fontSize:11, fontWeight:700, letterSpacing:".1em", textTransform:"uppercase", color:C.dim, marginBottom:4, display:"flex", alignItems:"center", gap:6 }}>Google Business Profile <ConfirmedBadge/></div>
                  <input type="text" value={form.gbp} onChange={e=>setField("gbp",e.target.value)} style={{ width:"100%", background:C.surf2, border:`1px solid ${C.border}`, borderRadius:6, padding:"9px 12px", fontSize:14, color:C.text, fontFamily:"'Plus Jakarta Sans',sans-serif", outline:"none", boxSizing:"border-box" }}/>
                </div>
              </div>

              {/* Hours + price + cuisine row */}
              <div style={{ display:"grid", gridTemplateColumns:"2fr 1fr 1fr", gap:12 }} className="three-col">
                <div>
                  <div style={{ fontSize:11, fontWeight:700, letterSpacing:".1em", textTransform:"uppercase", color:C.dim, marginBottom:4, display:"flex", alignItems:"center", gap:6 }}>
                    Current Hours {form.hours_text ? <ConfirmedBadge/> : <span style={{ fontSize:11, color:C.dim }}>Not available</span>}
                  </div>
                  <input type="text" value={form.hours_text} onChange={e=>setField("hours_text",e.target.value)} placeholder="e.g. Mon-Fri 11AM-10PM" style={{ width:"100%", background:C.surf2, border:`1px solid ${C.border}`, borderRadius:6, padding:"9px 12px", fontSize:13, color:C.text, fontFamily:"'Plus Jakarta Sans',sans-serif", outline:"none", boxSizing:"border-box" }}/>
                </div>
                <div>
                  <div style={{ fontSize:11, fontWeight:700, letterSpacing:".1em", textTransform:"uppercase", color:C.dim, marginBottom:4, display:"flex", alignItems:"center", gap:6 }}>
                    Price Point {form.price_level ? <ConfirmedBadge/> : null}
                  </div>
                  <input type="text" value={form.price_level} onChange={e=>setField("price_level",e.target.value)} placeholder="$, $$, $$$" style={{ width:"100%", background:C.surf2, border:`1px solid ${C.border}`, borderRadius:6, padding:"9px 12px", fontSize:14, color:C.text, fontFamily:"'Plus Jakarta Sans',sans-serif", outline:"none", boxSizing:"border-box" }}/>
                </div>
                <div>
                  <div style={{ fontSize:11, fontWeight:700, letterSpacing:".1em", textTransform:"uppercase", color:C.dim, marginBottom:4, display:"flex", alignItems:"center", gap:6 }}>
                    Cuisine {form.cuisine_types ? <ConfirmedBadge/> : null}
                  </div>
                  <input type="text" value={form.cuisine_types} onChange={e=>setField("cuisine_types",e.target.value)} placeholder="e.g. bar, american" style={{ width:"100%", background:C.surf2, border:`1px solid ${C.border}`, borderRadius:6, padding:"9px 12px", fontSize:14, color:C.text, fontFamily:"'Plus Jakarta Sans',sans-serif", outline:"none", boxSizing:"border-box" }}/>
                </div>
              </div>

              {/* Rating row */}
              {(form.rating || form.review_count) && (
                <div style={{ display:"flex", alignItems:"center", gap:16, padding:"10px 14px", background:C.surf2, borderRadius:8 }}>
                  <div style={{ fontSize:11, fontWeight:700, letterSpacing:".1em", textTransform:"uppercase", color:C.dim }}>Google Rating</div>
                  {form.rating && <div style={{ fontSize:18, fontWeight:700, color:C.orange, fontFamily:"'Oswald',sans-serif" }}>{form.rating} <span style={{ fontSize:13, color:C.dim, fontWeight:400 }}>/ 5</span></div>}
                  {form.review_count && <div style={{ fontSize:14, color:C.muted }}>{Number(form.review_count).toLocaleString()} reviews</div>}
                  <ConfirmedBadge/>
                </div>
              )}
              ...
              <div style={{ display:"flex", alignItems:"center", gap:12, paddingTop:4 }}>
                <button onClick={handleConfirm} disabled={!form.website.trim()} style={{ background:form.website.trim()?C.orange:"transparent", border:`1px solid ${form.website.trim()?C.orange:C.border}`, borderRadius:20, padding:"9px 22px", cursor:form.website.trim()?"pointer":"not-allowed", fontSize:13, fontWeight:700, letterSpacing:".08em", textTransform:"uppercase", color:form.website.trim()?"#fff":C.dim, fontFamily:"'Plus Jakarta Sans',sans-serif", transition:"all .15s" }}>
                  This looks right - unlock prompts
                </button>
                <button onClick={() => { setForm(f => ({ ...f, name:"", address:"", website:"", gbp:"", phone:"", hours_text:"", price_level:"", cuisine_types:"", rating:"", review_count:"" })); }} style={{ background:"none", border:`1px solid ${C.border}`, borderRadius:20, padding:"9px 18px", cursor:"pointer", fontSize:13, fontWeight:700, letterSpacing:".08em", textTransform:"uppercase", color:C.dim, fontFamily:"'Plus Jakarta Sans',sans-serif" }}>
                  Search again
                </button>
              </div>
        ...
        {/* ── CONFIRMED STATE ── */}
        {placesConfirmed && (
          <div style={{ border:`1px solid ${C.orange}`, borderRadius:10, padding:"14px 18px", marginBottom:16, display:"flex", alignItems:"center", justifyContent:"space-between", gap:16 }}>
            <div style={{ display:"flex", alignItems:"center", gap:12, flex:1, minWidth:0 }}>
              <svg width="20" height="20" viewBox="0 0 20 20" fill="none" style={{ flexShrink:0 }}><circle cx="10" cy="10" r="9" stroke={C.orange} strokeWidth="1.5"/><path d="M6 10l3 3 5-5" stroke={C.orange} strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"/></svg>
              <div style={{ minWidth:0 }}>
                <div style={{ fontSize:14, fontWeight:700, color:C.text, whiteSpace:"nowrap", overflow:"hidden", textOverflow:"ellipsis" }}>{form.name || form.address}</div>
                <div style={{ fontSize:12, color:C.dim, marginTop:2 }}>{form.address}</div>
              </div>
              {form.rating && <div style={{ fontSize:13, fontWeight:700, color:C.orange, fontFamily:"'Oswald',sans-serif", flexShrink:0 }}>{form.rating} &#9733; <span style={{ color:C.dim, fontWeight:400 }}>({form.review_count})</span></div>}
            </div>
            <button onClick={handleEdit} style={{ background:"none", border:`1px solid ${C.border}`, borderRadius:20, padding:"6px 14px", cursor:"pointer", fontSize:12, fontWeight:700, letterSpacing:".08em", textTransform:"uppercase", color:C.dim, fontFamily:"'Plus Jakarta Sans',sans-serif", flexShrink:0 }}>Edit</button>
          </div>
        )}

        {/* ── MORE CONTEXT (always available after confirm) ── */}
