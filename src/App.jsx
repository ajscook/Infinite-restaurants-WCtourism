  ...
  <style>{`
    *,*::before,*::after{box-sizing:border-box;margin:0;padding:0;}
    ...
    @media(max-width:720px){
      ...
      .pillar-card span{font-size:15px!important;}
      .sf-card span{font-size:15px!important;}
          ...
          <div key={i} style={{ flex: 1, padding: "22px 20px", textAlign: "center", display: "flex", flexDirection: "column", alignItems: "center", gap: 6, borderRight: i < 3 ? `1px solid ${C.orange}` : "none" }}>
            <div className="n" style={{ fontSize: "clamp(22px,3vw,36px)", fontWeight: 700, lineHeight: 1 }}>
              {s.n.split(/([.+\-$&/])/).map((part, pi) =>
                /^[.+\-$&/]$/.test(part)
                  ? <span key={pi} style={{ color: C.text }}>{part}</span>
        ...
        <div style={{ display: "flex", alignItems: "center", flex: 1, gap: 16, flexWrap: "wrap" }}>
          ...
          <div style={{ flex: 1, textAlign: "center", minWidth: 60 }}>
            <div className="n" style={{ fontSize: 38, fontWeight: 700, lineHeight: 1 }}>
              <span style={{ color: C.text }}>~</span><span style={{ color: C.blue }}>2</span><span style={{ color: C.text }}>x</span>
            </div>
          ...
          <div style={{ flex: 1, textAlign: "center", minWidth: 60 }}>
            <div className="n" style={{ fontSize: 38, fontWeight: 700, lineHeight: 1 }}>
              <span style={{ color: C.orange }}>3</span><span style={{ color: C.text }}>x</span>
            </div>
          ...
          <div style={{ flex: 1, textAlign: "center", minWidth: 60 }}>
            <div className="n" style={{ fontSize: 38, fontWeight: 700, lineHeight: 1 }}>
              <span style={{ color: C.blue }}>6</span><span style={{ color: C.text }}>.</span><span style={{ color: C.blue }}>5</span><span style={{ color: C.text }}>x</span>
            </div>
