  ...
  return (
    <Sec id="ai" num="05" label="HI-AI-HI Prompts" accent={C.blue}>
      <h2 className="d" style={{ fontSize:"clamp(28px,4.2vw,48px)", fontWeight:800, lineHeight:1.04, letterSpacing:"-.02em", marginBottom:14, color:C.text }}>
        ...
        <span style={{ color:C.text }}>Free your </span><span style={{ color:C.blue }}>Instinct</span>
      </h2>
      <p style={{ fontSize:19, color:C.muted, fontWeight:300, lineHeight:1.78, marginBottom:24, maxWidth:"90%" }}>
        12 years of tournament tourism data, complex regional planning, supply chain variables across 16 host markets - there's a substantial library here. This 2-Prompt structure will help you bring this research and more of your local World Cup context into your familiar AI platform to serve as your librarian.
      </p>
      ...
      <button onClick={() => setBriefOpen(o => !o)} style={{ width:"100%", background:"none", border:"none", cursor:"pointer", padding:0, display:"block", textAlign:"left" }}>
        <div className="card-blue" style={{ background:C.surface, borderRadius:12, padding:"20px 22px", display:"flex", flexDirection:"column" }}>
          <div style={{ fontSize:20, fontWeight:700, letterSpacing:".08em", textTransform:"uppercase", color:C.text, marginBottom:8 }}>Brief Your AI</div>
          <p style={{ fontSize:16, color:C.muted, lineHeight:1.75, marginBottom:16 }}>Seven questions. Your AI comes back knowing your restaurant and what the World Cup means for it specifically - then opens a planning conversation already loaded with what it found.</p>
          <div style={{ marginTop:"auto", display:"flex", justifyContent:"flex-end" }}>
            <div style={{ width:32, height:32, flexShrink:0, borderRadius:6, border:`2px solid ${briefOpen?C.blue:C.blue}`, display:"flex", alignItems:"center", justifyContent:"center", transition:"transform .3s,border-color .2s", transform:briefOpen?"rotate(45deg)":"none", color:briefOpen?C.blue:C.blue }}><svg width="13" height="13" viewBox="0 0 13 13" fill="none"><path d="M6.5 1v11M1 6.5h11" stroke="currentColor" strokeWidth="2.2" strokeLinecap="round"/></svg></div>
          </div>
        </div>
      </button>
      ...
      <div style={{ marginTop:16 }}>
        <button onClick={() => setShotsOpen(o => !o)} style={{ width:"100%", background:"none", border:"none", cursor:"pointer", padding:0, display:"block", textAlign:"left" }}>
          <div className="card-blue" style={{ background:C.surface, borderRadius:12, padding:"20px 22px", display:"flex", flexDirection:"column" }}>
            <div style={{ fontSize:20, fontWeight:700, letterSpacing:".08em", textTransform:"uppercase", color:C.text, marginBottom:8 }}>One-Shot AI Chat Starters</div>
            <p style={{ fontSize:16, color:C.muted, lineHeight:1.75, marginBottom:16 }}>Sorted by the four prep pillars. Pick the one that's most urgent, get a prompt scoped to that topic, take it into whichever AI platform you use.</p>
            <div style={{ marginTop:"auto", display:"flex", justifyContent:"flex-end" }}>
      ...
      <div style={{ marginTop:16 }}>
        <button onClick={() => setHiOpen(o => !o)} style={{ width:"100%", background:"none", border:"none", cursor:"pointer", padding:0, display:"block", textAlign:"left" }}>
          <div className="card-orange" style={{ background:C.surface, borderRadius:12, padding:"20px 22px", display:"flex", flexDirection:"column" }}>
            <div>
              <div style={{ display:"flex", alignItems:"center", gap:6, marginBottom:8, flexWrap:"wrap" }}>
                <span className="n" style={{ fontSize:14, fontWeight:700, letterSpacing:".14em", color:C.text }}>HI</span>
                <svg width="7" height="11" viewBox="0 0 7 11" fill="none"><polygon points="0,0 7,5.5 0,11" fill={C.blue}/></svg>
                <span className="n" style={{ fontSize:14, fontWeight:700, letterSpacing:".14em", color:C.text }}>AI</span>
                <svg width="7" height="11" viewBox="0 0 7 11" fill="none"><polygon points="0,0 7,5.5 0,11" fill={C.blue}/></svg>
                <span className="n" style={{ fontSize:14, fontWeight:700, letterSpacing:".14em", color:C.text }}>HI:</span>
                <span style={{ fontSize:14, fontWeight:700, letterSpacing:".14em", textTransform:"uppercase", color:C.text }}>Human </span><span style={{ fontSize:14, fontWeight:700, letterSpacing:".14em", textTransform:"uppercase", color:C.blue }}>Intellect</span>
                <span style={{ fontSize:14, fontWeight:700, letterSpacing:".14em", color:C.dim, margin:"0 4px" }}>|</span>
                <span style={{ fontSize:14, fontWeight:700, letterSpacing:".14em", textTransform:"uppercase", color:C.orange }}>AI</span>
                <span style={{ fontSize:14, fontWeight:700, letterSpacing:".14em", color:C.dim, margin:"0 4px" }}>|</span>
                <span style={{ fontSize:14, fontWeight:700, letterSpacing:".14em", textTransform:"uppercase", color:C.text }}>Hospitality </span><span style={{ fontSize:14, fontWeight:700, letterSpacing:".14em", textTransform:"uppercase", color:C.blue }}>Instinct</span>
              </div>
              <div style={{ fontSize:19, fontWeight:700, letterSpacing:".08em", textTransform:"uppercase", color:C.text, marginBottom:8 }}>Philosophy, Platforms &amp; Reading the Output</div>
              <p style={{ fontSize:16, color:C.muted, lineHeight:1.75, marginBottom:16 }}>How this platform thinks about AI, which tools to use, and how to know when to trust what comes back.</p>
            </div>
            <div style={{ marginTop:"auto", display:"flex", justifyContent:"flex-end" }}>
              <div style={{ width:32, height:32, flexShrink:0, borderRadius:6, border:`2px solid ${hiOpen?C.orange:C.orange}`, display:"flex", alignItems:"center", justifyContent:"center", transition:"transform .3s,border-color .2s", transform:hiOpen?"rotate(45deg)":"none", color:hiOpen?C.orange:C.orange }}><svg width="13" height="13" viewBox="0 0 13 13" fill="none"><path d="M6.5 1v11M1 6.5h11" stroke="currentColor" strokeWidth="2.2" strokeLinecap="round"/></svg></div>
            </div>
          </div>
        </button>
