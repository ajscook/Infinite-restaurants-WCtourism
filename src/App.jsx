    ...
    <Sec id="ai" num="05" label="HI ∞ AI ∞ HI Prompts" accent={C.blue}>
      ...
      <button onClick={() => setBriefOpen(o => !o)} style={{ width:"100%", background:"none", border:"none", cursor:"pointer", padding:0, display:"block", textAlign:"left" }}>
        <div className="card-blue" style={{ background:C.surface, borderRadius:12, padding:"20px 22px", display:"flex", flexDirection:"column" }}>
          ...
          <p style={{ fontSize:18, color:C.muted, lineHeight:1.75, marginBottom:16 }}>Seven questions. Three prompts. Your AI profiles your operation, researches your local market, then opens a planning conversation already loaded with both.</p>
          <div style={{ marginTop:"auto", display:"flex", justifyContent:"flex-end" }}>
      ...
      <div className={`xbody ${briefOpen?"open":""}`}>
        <div style={{ padding:"24px 4px 8px", display:"flex", flexDirection:"column", gap:18 }}>

          {/* Prompt 1 */}
          <div className="callout-left-blue">
            <div style={{ fontSize:13, fontWeight:700, letterSpacing:".12em", textTransform:"uppercase", color:C.blue, marginBottom:8 }}>Prompt 1 <span style={{ color:C.orange }}>[DEEP RESEARCH]</span><span style={{ color:C.text }}>: Operator Profile</span></div>
            <p style={{ fontSize:18, color:C.muted, lineHeight:1.78, margin:0 }}>Goes to your AI in deep research mode with one job: access the Infinite Restaurants platform research, read it completely, then map your operation against what it finds. Where you sit in the surge geography. What your pressure points are. What decisions you haven't made yet.</p>
          </div>

          <div style={{ paddingLeft:4 }}>
            <div style={{ fontSize:14, fontWeight:700, letterSpacing:".1em", textTransform:"uppercase", marginBottom:6 }}>
              <span style={{ color:C.orange }}>[HI ∞ AI ∞ HI:</span><span style={{ color:C.text }}> Human in the Loop, Human in the Lead]</span>
            </div>
            <p style={{ fontSize:18, color:C.muted, lineHeight:1.78, margin:0 }}>Read that output before you do anything else. This is not a pause. It's the work. Your instinct needs to confirm the profile before it goes further. If something is wrong, correct it before prompt two.</p>
          </div>

          {/* Prompt 2 */}
          <div className="callout-left-blue">
            <div style={{ fontSize:13, fontWeight:700, letterSpacing:".12em", textTransform:"uppercase", color:C.blue, marginBottom:8 }}>Prompt 2 <span style={{ color:C.orange }}>[DEEP RESEARCH]</span><span style={{ color:C.text }}>: Local Intelligence</span></div>
            <p style={{ fontSize:18, color:C.muted, lineHeight:1.78, margin:0 }}>Takes your confirmed profile and researches the local specifics for your market. Confirmed fan zones in your region. Team base camp locations. DOT corridor data for the tournament window. State or provincial liquor license requirements. Local scheduling and fair workweek ordinances. Everything jurisdiction-specific comes back labeled as directional only. The AI is searching, not confirming. Read it with that in mind.</p>
          </div>
          ...
          <div style={{ paddingLeft:4 }}>
            ...
            <p style={{ fontSize:18, color:C.muted, lineHeight:1.78, margin:0 }}>Review the local intelligence. Flag anything that needs verification before it becomes a planning assumption. What you verify is your call. The AI cannot make that judgment for you.</p>
          </div>

          {/* Prompt 3 */}
          <div className="callout-left-blue">
            <div style={{ fontSize:13, fontWeight:700, letterSpacing:".12em", textTransform:"uppercase", color:C.blue, marginBottom:8 }}>Prompt 3 - Planning Conversation</div>
            <p style={{ fontSize:18, color:C.muted, lineHeight:1.78, margin:0 }}>Opens the planning conversation already loaded with both outputs. Your AI isn't starting cold. You're not explaining your situation from scratch. You direct the conversation toward whatever decision is most urgent.</p>
          </div>
          ...
          <div style={{ display:"flex", alignItems:"center", gap:14, flexWrap:"wrap", paddingTop:4 }}>
            ...
            <span style={{ fontSize:13, color:C.dim }}>Generates all three prompts at once.</span>
          </div>
