    ...
    debounceRef.current = setTimeout(async () => {
      try {
        ...
        const req = {
          ...
          includedPrimaryTypes: ["restaurant","bar","cafe","bakery","meal_takeaway","meal_delivery"],
        };
...
const OfframpTile = ({ platformKey, onOpen }) => {
  ...
  return (
    <div className={p.cardClass} onClick={() => onOpen(platformKey)}
      ...
      <div style={{ width:56, height:56, flexShrink:0, borderRadius:10, background:C.surf2, border:`1px solid ${C.border}`, display:"flex", alignItems:"center", justifyContent:"center", overflow:"hidden" }}>
        <img src={`https://infiniterestaurants.ai/${platformKey}.png`} alt={p.name} style={{ width:"100%", height:"100%", objectFit:"contain", display:"block" }} onError={e => { e.currentTarget.style.display="none"; }} />
      </div>
