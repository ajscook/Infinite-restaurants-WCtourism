  ...
  placesLoaderPromise = new Promise((resolve, reject) => {
    ...
    const onReady = () => {
      if (window.google?.maps?.importLibrary) {
        ...
        reject(new Error("Google Maps loader unavailable"));
      }
    };
    if (existing) {
...
const OfframpTile = ({ platformKey, onOpen }) => {
  ...
  return (
    <div className={p.cardClass} onClick={() => onOpen(platformKey)}
      style={{ background:C.surface, borderRadius:12, padding:"24px 20px", cursor:"pointer", display:"flex", flexDirection:"column", alignItems:"center", justifyContent:"center", textAlign:"center", height:"100%", minHeight:120 }}>
