...
// ─── WORLD CUP RESEARCH CARD ─────────────────────────────────────────────────
const WorldCupResearchCard = () => (
  <div className="card-orange" style={{ background:C.surface, borderRadius:12, padding:"28px 32px", marginTop:24 }}>
    <div style={{ fontSize:13, fontWeight:700, letterSpacing:".14em", textTransform:"uppercase", color:C.orange, marginBottom:12 }}>For operators who already use AI</div>
    <div className="two-col" style={{ display:"grid", gridTemplateColumns:"1fr auto", gap:32, alignItems:"start" }}>
      <div>
        <div className="d" style={{ fontSize:"clamp(19px,2.4vw,24px)", fontWeight:800, color:C.text, lineHeight:1.15, marginBottom:14 }}>
          Load this research into the AI that already knows you.
        </div>
        <p style={{ fontSize:15, color:C.muted, lineHeight:1.78, marginBottom:0 }}>
          Seven questions about your operation. Two prompts. The first maps your specifics against the tournament framework in deep research mode. Read what comes back. Then Prompt 2 opens a planning conversation in your own AI - loaded with the research and what it already knows about you - so the conversation starts where it should.
        </p>
      </div>
      <div style={{ display:"flex", flexDirection:"column", gap:8, alignItems:"flex-end" }}>
        <GenButton generatorId="world_cup_research" label="Build My Prompts" />
        <div style={{ fontSize:12, color:C.dim, textAlign:"right" }}>Generates both prompts at once.</div>
      </div>
    </div>
  </div>
);
