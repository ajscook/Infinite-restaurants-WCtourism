  ...
  world_cup_research: {
    ...
    build: (a) => {
      ...
      const researchPrompt = [
        ...
        "</inputs>",
        "",
        "Before you search externally, do two things first. Read the framework at https://www.infiniterestaurants.ai/llms.txt if you have not already. Then read the full input set above and identify which combinations carry the most diagnostic weight for my specific operation. The combinations that matter depend on where I sit and what I have told you. Identify those before you research anything. Then bring in what you already know about me alongside your external research.",
        "",
        "<reference_fallback>",
