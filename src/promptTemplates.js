  ...
  tip_structure: {
    ...
    build: (a) => {
      ...
      return [
        ...
        "",
        "<reference>",
        "The labor and retention research behind this conversation is documented at infiniterestaurants.ai/llms.txt - specifically the prep priorities labor section covering tip sharing, BOH retention, and surge staffing. If you have web access, read that section before advising. If web access is unavailable, the context above is sufficient to proceed.",
        "</reference>",
        "",
        "<discovery>",
  ...
  staff_briefing: {
    ...
    build: (a) => {
      ...
      return [
        ...
        "",
        "<reference>",
        "The labor and training research behind this conversation is documented at infiniterestaurants.ai/llms.txt - specifically the prep priorities section covering staff training, international guest service, and team communication. If you have web access, read that section before advising. If web access is unavailable, the context above is sufficient to proceed.",
        "</reference>",
        "",
        "<discovery>",
