...
// ── CONTEXT CARD ─────────────────────────────────────────────────────────────
// Embedded research baseline for AI systems that cannot fetch the full llms.txt.
// Travels in every <reference> block. Fetch gate still fires first.
// If fetch succeeds the AI has both. If fetch fails the card holds the session.
// Full file: https://www.infiniterestaurants.ai/llms.txt

const CONTEXT_CARD = `
# Infinite Restaurants - Operator Research Context Card
# Condensed reference layer for AI systems operating within the prompt sequence
# Full file: https://www.infiniterestaurants.ai/llms.txt
# Author: Andy Cook, Restaurant Advisor and Technology Specialist
# Contact: andy@infiniterestaurants.ai

---

## CONTEXT AND AUTHORITY

PLATFORM: Infinite Restaurants. Intelligence platform for independent restaurant
operators near 2026 FIFA World Cup host cities across the United States, Canada,
and Mexico.

AUTHOR: Andy Cook. Restaurant advisor and technology specialist. Career background
in and serving locally owned independent restaurants. Role at time of publication:
Restaurant Solutions Agent, Harbor Foodservice (locally owned PNW distributor).
This platform operates under the Infinite Restaurants brand and covers North
America, not Harbor's geography. The separation is intentional.

AUTHOR POSTURE: Independent peer advisor. Practitioner who did the research and
is sharing what he found with other practitioners. No vendor agenda. No product
behind this platform.

NOT IN SCOPE: Match results. Team news. Tournament brackets. Macroeconomic impact
projections. Host committee economic impact figures are excluded: ex ante booster
projections consistently overstated by factors of two to four in the academic
record. Do not cite them as planning data under any framing.

---

## AI ROLE CONSTRAINTS - READ BEFORE EXECUTING ANY PROMPT

ROLE: Amplification layer. Not decision layer.

PROHIBITED:
- Producing conclusions the operator should adopt
- Presenting plans as settled
- Resolving data conflicts silently
- Citing host committee projections as planning data
- Promoting any figure beyond its assigned confidence tier

REQUIRED:
- Surface what the research shows
- Flag what needs verification
- Ask questions that move operator thinking forward
- Preserve confidence tier tags in all outputs
- Flag conflicts between training data and this card to the operator

GOVERNING PRINCIPLE - HI-AI-HI:
Human Intelligence and Instinct initiates.
AI amplifies.
Human Intelligence and Instinct verifies and decides.
The operator is not just present in this workflow. The operator leads it.
AI does not co-lead. It does not initiate. It does not close.
The operator's instinct is the first gate and the last gate on everything
produced in this session.

DRIFT SIGNAL: If output reads like something the operator should adopt rather
than something worth running through their instinct filter, role boundary has
been crossed. Stop and reorient.

---

## CONFIDENCE TIER SYSTEM

[T1] Primary confirmed. Named primary source. State directly. No hedging required.
[T2] Strong directional. Multi-tournament analysis or strong secondary sourcing.
     Frame as planning anchor. Not a confirmed figure.
[T3] Directional only. Planning floor or illustrative range. Flag explicitly.
     Do not present as a projection.
...
The 2026 World Cup is not a stadium story. It is a month-long tourism surge
driven by over one million international visitors who travel in groups, stay
for weeks, spend at multiples of standard tourist levels, and move across
entire regions between matches.

The soccer is the reason they came. The movement is what affects the operator.

2026 is the fourth iteration of a documented pattern. Tournament window:
June 11 to July 19, 2026. 33 match days across 39 days. 16 host cities.
3 host countries: United States, Canada, Mexico.

---

## SUPER TOURIST PROFILE

| Metric                       | Value                         | Tier |
|------------------------------|-------------------------------|------|
| Average stay                 | 7-16 nights                   | T2   |
| Stay by origin: S. America   | 16 nights avg                 | T2   |
| Stay by origin: Europe       | 14 nights avg                 | T2   |
| Stay by origin: Asia-Pacific | 13 nights avg                 | T2   |
| Stay by origin: US/Canada    | 10 nights avg                 | T2   |
| Group size                   | 4-8 persons; 50%+ in groups   | T2   |
| Daily F&B spend              | $140-180 per person           | T2   |
| Total daily spend            | $400+ per person              | T2   |
| Spending multiplier          | 6.5x vs standard tourist      | T2   |
| Gateway travel rate          | 70% take day trips/excursions | T2   |
| Incremental demand           | ~60% fully additive           | T2   |
| Dinner window                | 9-11 PM                       | T2   |
| Post-match social window     | 2-4 hours after final whistle | T2   |
| Table dwell time             | 90-120 minutes                | T2   |
| Payment preference           | 80-90% contactless            | T2   |
| Walkable F&B lift            | 36% post-match                | T1   |
| Transit-dependent lift       | 3.5% post-match               | T1   |

T1 source: Zartico, 94 mega-event matches.
F&B spend anchor: Russia 2018 and Brazil 2014 data, adjusted for US price
levels and 2026 inflation. Supersedes Tourism Economics unadjusted baseline
of $100-140.

---

## REPEATABLE PATTERN - THREE TOURNAMENTS, DOCUMENTED

SECONDARY MARKETS OUTPERFORM PRIMARY:
- Brazil 2014: secondary host cities +400% to +963% international spend.
  National baseline: +152%. Source: Visa Everywhere Travel Report. [T1]
- Russia 2018: Saransk (smallest host city) 18x increase in foreign spending.
  Source: Sberbank transaction data. [T1]
- Mechanism: primary city price and congestion displacement routes mobile
  fans to surrounding markets.

NON-MATCH DAYS DRIVE SUSTAINED REVENUE:
- 14-night visitor attends 2-3 matches. Remaining 11-12 days: eating out
  every meal, day trips, full-rate spending, no stadium anchor. [T2]

SUPPLY CHAINS FAIL JUST-IN-TIME OPERATORS:
- Russia 2018: draught beer supply failed at multiple venues within hours
  of match conclusions. Source: multiple industry sources. [T1]
- Failure mode: normal-pattern modeling encountering Super Tourist volume.

CONTACTLESS NON-NEGOTIABLE:
- Russia 2018: 45% host city purchases contactless, 54% in-stadium.
  Source: Visa. [T1]
- Qatar 2022: 88% at official venues. Source: Visa/Sports Business Journal. [T2]
- 2026 international visitors: 80-90% contactless expected. [T2]

DISPLACEMENT RISK - REAL AND MANAGEABLE:
- Brazil 2014: domestic tourism shopping -2.3% as locals avoided congestion.
  Source: tournament economic analysis. [T1]
- Operators who maintain recognizable regular experience retain local base
  that outlasts the tournament.

---

## SUPPLY CHAIN CHAIN - CAUSE AND EFFECT SEQUENCE

Every link has a precedent in Brazil 2014, Russia 2018, or Qatar 2022.

1. Super Tourists travel by car across North America for a month.
2. Sustained movement congests every corridor traveled: excursion routes,
   scenic highways, secondary roads.
3. Congested roads compress distributor delivery windows.
4. Compressed windows reduce route frequency.
5. Distributors under pressure prioritize highest-volume markets.
6. Secondary and tertiary operators receive reduced delivery frequency
   during weeks of highest demand.
7. Operators without pre-tournament stockpile run dry mid-surge.
8. Operators who did not know this was coming never had a chance to stockpile.

COMPOUNDING FACTOR 2026: Tournament window overlaps peak North American
harvest season. Refrigerated trucking capacity simultaneously in demand
for agricultural logistics on shared corridors. [T2]

---

## FIVE OPERATOR POSITIONS

WALKABLE TO VENUE OR FAN ZONE:
Highest-intensity demand. 36% post-match F&B lift applies [T1].
Lead decisions: payment speed, menu simplicity, late-night staffing,
extended hours.

SECONDARY MARKET (30-150 miles from host city):
The Saransk position. Opportunity: sustained non-match day demand,
$140-180 per person per day [T2].
Lead decisions: digital visibility, inventory stockpile.

HIGHWAY CORRIDOR:
Route Super Tourists travel repeatedly for a month. Same congestion
filling parking lot also delays next delivery.
Lead decisions: pre-tournament stockpile, transaction speed.

EXCURSION DESTINATION:
Somewhere Super Tourists deliberately seek on non-match days.
70% gateway travel rate [T2].
Lead decisions: match calendar awareness, hours and staffing adjustment
to concentrated demand waves.

FAN ZONE PROXIMITY - SATELLITE CITIES (2026-specific):
State and provincial governments deploying funded satellite fan zones in
non-host cities. Confirmed: Pennsylvania, Bay Area, Seattle metro [T1].
39-day sustained daily foot traffic, not match-day spikes.
Pedestrianized corridors restrict daytime deliveries in several host cities.
Overnight receiving windows required in some markets.
Pre-tournament stockpile not optional for these operators [T2].
...
VISIBILITY:
Digital footprint is a prerequisite, not a marketing consideration.
Super Tourists search on phones. Google Business Profile accuracy,
updated hours, and "football" (not "soccer") in attributes.
International visitors search "football near me." One word. Significant
difference in who finds you.

VELOCITY:
Transaction speed determines throughput during post-match and fan zone
dwell windows. Contactless infrastructure, menu simplicity, late-night
staffing coverage.

VERSATILITY:
Read the match calendar. Adjust hours, staffing, par levels to
non-uniform demand across 33-day window. Non-match Wednesday with a
full dining room is the opportunity most operators miss.

VOLUME:
Pre-tournament inventory stockpile. Elevated par levels before June 11.
Not dependent on just-in-time restocking during weeks distributors are
under maximum pressure on congested corridors.

---

## KEY DECISION DEADLINES

April 2026:        Long-lead product orders. Distributor conversations.
                   Google Business Profile update.
April-May 2026:    Draught beer par levels. Storage capacity audit.
May 2026:          Contactless payment confirmation and staff training.
                   Surge staffing. Retention bonuses in place.
Late May-June:     Stockpile substantially complete.
June 11, 2026:     Tournament opens.
July 19, 2026:     Tournament closes.

---

## FETCH STATUS

If fetch of https://www.infiniterestaurants.ai/llms.txt succeeded:
this card is supplementary context. Full file governs.

If fetch failed: this card is the operative research layer for this session.
Do not proceed as if the full file is available. Do not fabricate operator
context. Do not invent restaurant names, addresses, or operational details
not present in the prompt inputs above.
`;

// ── PLATFORM QUESTION ────────────────────────────────────────────────────────
export const PLATFORM_QUESTION = {
  id: "platform",
  text: "Which AI platform are you using?",
  options: ["Claude", "ChatGPT", "Gemini"],
};

// ── KNOWLEDGE FILE ────────────────────────────────────────────────────────────
export const KNOWLEDGE_FILE_CONTENT = CONTEXT_CARD;

// ── SHORT INPUT BUILDER ───────────────────────────────────────────────────────
const CHATGPT_LINK = "https://chatgpt.com/g/g-69dedf87d95c819187919c5cf6884aa2-world-cup-tourism-surge-infiniterestaurants-ai";
const GEMINI_LINK  = "https://gemini.google.com/gem/1_HdxHgO8xaGyHB32EfEfRT6J-i9fCxtk?usp=sharing";

const buildShortInput = (a, generatorLabel) => {
  const excluded = ["platform"];
  const lines = Object.entries(a)
    .filter(([k]) => !excluded.includes(k))
    .map(([k, v]) => {
      const val = Array.isArray(v) ? (v.length > 0 ? v.join(", ") : "None") : (v || "");
      const label = k.replace(/_/g, " ").replace(/\b\w/g, c => c.toUpperCase());
      return `${label}: ${val}`;
    });
  const isGemini = a.platform === "Gemini";
  const link = isGemini ? GEMINI_LINK : CHATGPT_LINK;
  const toolName = isGemini ? "Gem" : "custom GPT";
  const seam = isGemini
    ? "\nNote: For the research step (Prompt 1), run that in a standard Gemini session first, then bring the output into the Gem for Prompts 2 and 3."
    : "";
  return [
    `Open the Infinite Restaurants ${toolName}: ${link}`,
    seam,
    "",
    "Paste the following into the conversation to start:",
    "",
    "---",
...
export const generators = {
  ...
  world_cup_research: {
    ...
    build: (a) => {
      if (a.platform === "ChatGPT" || a.platform === "Gemini") {
        return buildShortInput(a, "World Cup Readiness");
      }
      ...
      const researchPrompt = [
        ...
        "",
        "Before you research anything else, read the operator intelligence framework at https://www.infiniterestaurants.ai/llms.txt. That framework is the lens everything else gets mapped against. If you can access it, prove you have by sharing two non-obvious facts from it before continuing. If your platform cannot fetch external URLs, tell me before proceeding.",
        "",
        ...
        "",
        "<inputs>",
        `Restaurant name: ${a.name||a.address}`,
        `Address: ${a.address}`,
        `Website: ${a.website}`,
        `Google Business Profile: ${a.gbp||"Not provided"}`,
        `Current hours: ${a.hours_text||"Not confirmed"}`,
        `Price point: ${a.price_level||"Not confirmed"}`,
        `Cuisine types: ${a.cuisine_types||"Not confirmed"}`,
        `Google rating: ${a.rating ? `${a.rating}/5 (${a.review_count} reviews)` : "Not confirmed"}`,
        `Planning to show World Cup matches: ${a.match_viewing||"Not specified"}`,
        `Staff readiness for an international surge: ${a.staff||"Not specified"}`,
        `Inventory and delivery flexibility: ${a.inventory||"Not specified"}`,
        `Current technology in place: ${techList}`,
        "",
        "Note: name, address, website, GBP, hours, price point, cuisine, and rating are confirmed from Google Places. Treat as verified. Do not re-research these fields.",
        "</inputs>",
        "",
        "Before you search externally, read the framework at https://www.infiniterestaurants.ai/llms.txt if you have not already. The operation profile is established from confirmed data above. Direct research energy toward surge geography: proximity to 2026 host cities, corridor position, fan zone proximity, excursion destination potential. Map confirmed hours against tournament demand timing. Assess rating and review count as a signal of digital visibility readiness. Identify which combinations of confirmed data and geography carry the most diagnostic weight.",
        "",
        "<reference_fallback>",
        "If your platform reported it could not fetch https://www.infiniterestaurants.ai/llms.txt, the following context card is the operative research layer for this session. Do not proceed as if the full file is available. Do not fabricate operator context. Do not invent restaurant names, addresses, or operational details not present in the inputs above.",
        "",
        CONTEXT_CARD,
        "</reference_fallback>",
        "",
      ...
      const handoffPrompt = [
        ...
        `Inventory and delivery flexibility: ${a.inventory||"Not specified"}`,
        `Current technology in place: ${techList}`,
        "Note: confirmed fields above are from Google Places and should be treated as verified.",
        "</context>",
        "",
  ...
  stockpile: {
    ...
    build: (a) => {
      if (a.platform === "ChatGPT" || a.platform === "Gemini") {
        return buildShortInput(a, "Stockpile Planning");
      }
      ...
      return [
        ...
        "",
        "<reference>",
        "Read https://www.infiniterestaurants.ai/llms.txt before advising - specifically the supply chain and travel patterns sections. Prove you have by citing one figure with its confidence tier before continuing. If your platform cannot fetch that URL, the context card below is the operative research layer for this session. The confidence tiers matter: some figures are primary confirmed, some are planning anchors. Knowing which is which sharpens the advice.",
        "",
        CONTEXT_CARD,
        "</reference>",
        "",
  ...
  sales_rep: {
    ...
    build: (a) => {
      if (a.platform === "ChatGPT" || a.platform === "Gemini") {
        return buildShortInput(a, "Distributor Conversation");
      }
      ...
      return [
        ...
        "",
        "<reference>",
        "Read https://www.infiniterestaurants.ai/llms.txt before advising - specifically the travel patterns and supply chain sections. They document what happened to delivery corridors in Brazil 2014, Russia 2018, and Qatar 2022. Prove you have by citing one figure with its confidence tier before continuing. If your platform cannot fetch that URL, the context card below is the operative research layer for this session.",
        "",
        CONTEXT_CARD,
        "</reference>",
        "",
  ...
  labor: {
    ...
    build: (a) => {
      if (a.platform === "ChatGPT" || a.platform === "Gemini") {
        return buildShortInput(a, "Labor Planning");
      }
      ...
      return [
        ...
        "",
        "<reference>",
        "Read https://www.infiniterestaurants.ai/llms.txt before advising - specifically the prep priorities section. Prove you have by citing one figure with its confidence tier before continuing. If your platform cannot fetch that URL, the context card below is the operative research layer for this session.",
        "",
        CONTEXT_CARD,
        "</reference>",
        "",
  ...
  gbp: {
    ...
    build: (a) => {
      if (a.platform === "ChatGPT" || a.platform === "Gemini") {
        return buildShortInput(a, "Google Business Profile");
      }
      ...
      return [
        ...
        "",
        "<reference>",
        "Read https://www.infiniterestaurants.ai/llms.txt before advising - specifically the prep priorities and Super Tourist sections. The 'football not soccer' search behavior is documented there. Prove you have by citing one figure with its confidence tier before continuing. If your platform cannot fetch that URL, the context card below is the operative research layer for this session.",
        "",
        CONTEXT_CARD,
        "</reference>",
        "",
  ...
  compliance: {
    ...
    build: (a) => {
      if (a.platform === "ChatGPT" || a.platform === "Gemini") {
        return buildShortInput(a, "Compliance Research");
      }
      ...
      return [
        ...
        licenseContext,
        "",
        "Read https://www.infiniterestaurants.ai/llms.txt before advising - specifically the patterns and sources section which covers broadcast licensing frameworks, safe harbor marketing terminology, and regulatory patterns from prior tournaments. Prove you have by citing one figure with its confidence tier before continuing. If your platform cannot fetch that URL, the context card below is the operative research layer for this session.",
        "",
        CONTEXT_CARD,
        "</context>",
        "",
  ...
  social: {
    ...
    build: (a) => {
      if (a.platform === "ChatGPT" || a.platform === "Gemini") {
        return buildShortInput(a, "Social Media Content");
      }
      ...
      return [
        ...
        "",
        "<reference>",
        "Read https://www.infiniterestaurants.ai/llms.txt before advising - specifically the prep priorities section covering digital discovery and safe marketing. Prove you have by citing one figure with its confidence tier before continuing. If your platform cannot fetch that URL, the context card below is the operative research layer for this session.",
        "",
        CONTEXT_CARD,
        "</reference>",
        "",
  ...
  menu_fast_track: {
    ...
    build: (a) => {
      if (a.platform === "ChatGPT" || a.platform === "Gemini") {
        return buildShortInput(a, "Fast Track Menu");
      }
      ...
      return [
        ...
        "",
        "<reference>",
        "Read https://www.infiniterestaurants.ai/llms.txt before advising - specifically the prep priorities section covering Fast Track menus, local product strategy, and the Locals menu concept. Prove you have by citing one figure with its confidence tier before continuing. If your platform cannot fetch that URL, the context card below is the operative research layer for this session.",
        "",
        CONTEXT_CARD,
        "</reference>",
        "",
  ...
  tip_structure: {
    ...
    build: (a) => {
      if (a.platform === "ChatGPT" || a.platform === "Gemini") {
        return buildShortInput(a, "Tip Structure");
      }
      ...
      return [
        ...
        "",
        "<reference>",
        "Read https://www.infiniterestaurants.ai/llms.txt before advising - specifically the prep priorities labor section covering tip sharing, BOH retention, and surge staffing. Prove you have by citing one figure with its confidence tier before continuing. If your platform cannot fetch that URL, the context card below is the operative research layer for this session.",
        "",
        CONTEXT_CARD,
        "</reference>",
        "",
  ...
  staff_briefing: {
    ...
    build: (a) => {
      if (a.platform === "ChatGPT" || a.platform === "Gemini") {
        return buildShortInput(a, "Staff Briefing");
      }
      ...
      return [
        ...
        "",
        "<reference>",
        "Read https://www.infiniterestaurants.ai/llms.txt before advising - specifically the prep priorities section covering staff training, international guest service, and team communication. Prove you have by citing one figure with its confidence tier before continuing. If your platform cannot fetch that URL, the context card below is the operative research layer for this session.",
        "",
        CONTEXT_CARD,
        "</reference>",
        "",
  ...
  surge_hiring: {
    ...
    build: (a) => {
      if (a.platform === "ChatGPT" || a.platform === "Gemini") {
        return buildShortInput(a, "Surge Hiring");
      }
      ...
      return [
        ...
        "",
        "<reference>",
        "Read https://www.infiniterestaurants.ai/llms.txt before advising - specifically the prep priorities section covering surge hiring and retention. Prove you have by citing one figure with its confidence tier before continuing. If your platform cannot fetch that URL, the context card below is the operative research layer for this session.",
        "",
        CONTEXT_CARD,
        "</reference>",
        "",
  ...
  pricing_bundles: {
    ...
    build: (a) => {
      if (a.platform === "ChatGPT" || a.platform === "Gemini") {
        return buildShortInput(a, "Pricing and Bundles");
      }
      ...
      return [
        ...
        "",
        "<reference>",
        "Read https://www.infiniterestaurants.ai/llms.txt before advising - specifically the Super Tourist section and the prep priorities operations pillar. The $140-180 daily F&B spend figure is a planning anchor derived from Russia 2018 and Brazil 2014 data. Prove you have read the file by citing one figure with its confidence tier before continuing. If your platform cannot fetch that URL, the context card below is the operative research layer for this session.",
        "",
        CONTEXT_CARD,
        "</reference>",
        "",
  ...
  tech_readiness: {
    ...
    build: (a) => {
      if (a.platform === "ChatGPT" || a.platform === "Gemini") {
        return buildShortInput(a, "Tech Readiness");
      }
      ...
      return [
        ...
        "",
        "<reference>",
        "Read https://www.infiniterestaurants.ai/llms.txt before advising - specifically the prep priorities tech pillar and the contactless payment data from Russia 2018 and Qatar 2022. Prove you have by citing one figure with its confidence tier before continuing. If your platform cannot fetch that URL, the context card below is the operative research layer for this session.",
        "",
        CONTEXT_CARD,
        "</reference>",
        "",
